var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.arrayIteratorImpl=function(t){var F=0;return function(){return F<t.length?{done:!1,value:t[F++]}:{done:!0}}};$jscomp.arrayIterator=function(t){return{next:$jscomp.arrayIteratorImpl(t)}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;$jscomp.FORCE_POLYFILL_PROMISE=!1;$jscomp.FORCE_POLYFILL_PROMISE_WHEN_NO_UNHANDLED_REJECTION=!1;
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(t,F,C){if(t==Array.prototype||t==Object.prototype)return t;t[F]=C.value;return t};$jscomp.getGlobal=function(t){t=["object"==typeof globalThis&&globalThis,t,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var F=0;F<t.length;++F){var C=t[F];if(C&&C.Math==Math)return C}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(t,F){var C=$jscomp.propertyToPolyfillSymbol[F];if(null==C)return t[F];C=t[C];return void 0!==C?C:t[F]};
$jscomp.polyfill=function(t,F,C,J){F&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(t,F,C,J):$jscomp.polyfillUnisolated(t,F,C,J))};$jscomp.polyfillUnisolated=function(t,F,C,J){C=$jscomp.global;t=t.split(".");for(J=0;J<t.length-1;J++){var O=t[J];if(!(O in C))return;C=C[O]}t=t[t.length-1];J=C[t];F=F(J);F!=J&&null!=F&&$jscomp.defineProperty(C,t,{configurable:!0,writable:!0,value:F})};
$jscomp.polyfillIsolated=function(t,F,C,J){var O=t.split(".");t=1===O.length;J=O[0];J=!t&&J in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var B=0;B<O.length-1;B++){var I=O[B];if(!(I in J))return;J=J[I]}O=O[O.length-1];C=$jscomp.IS_SYMBOL_NATIVE&&"es6"===C?J[O]:null;F=F(C);null!=F&&(t?$jscomp.defineProperty($jscomp.polyfills,O,{configurable:!0,writable:!0,value:F}):F!==C&&(void 0===$jscomp.propertyToPolyfillSymbol[O]&&(C=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[O]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(O):$jscomp.POLYFILL_PREFIX+C+"$"+O),$jscomp.defineProperty(J,$jscomp.propertyToPolyfillSymbol[O],{configurable:!0,writable:!0,value:F})))};$jscomp.initSymbol=function(){};$jscomp.iteratorPrototype=function(t){t={next:t};t[Symbol.iterator]=function(){return this};return t};$jscomp.underscoreProtoCanBeSet=function(){var t={a:!0},F={};try{return F.__proto__=t,F.a}catch(C){}return!1};
$jscomp.setPrototypeOf=$jscomp.TRUST_ES6_POLYFILLS&&"function"==typeof Object.setPrototypeOf?Object.setPrototypeOf:$jscomp.underscoreProtoCanBeSet()?function(t,F){t.__proto__=F;if(t.__proto__!==F)throw new TypeError(t+" is not extensible");return t}:null;$jscomp.makeIterator=function(t){var F="undefined"!=typeof Symbol&&Symbol.iterator&&t[Symbol.iterator];return F?F.call(t):$jscomp.arrayIterator(t)};$jscomp.generator={};
...
$jscomp.generator.Context.prototype.throw_=function(t){this.abruptCompletion_={exception:t,isException:!0};this.jumpToErrorHandler_()};$jscomp.generator.Context.prototype.return=function(t){this.abruptCompletion_={return:t};this.nextAddress=this.finallyAddress_};$jscomp.generator.Context.prototype.jumpThroughFinallyBlocks=function(t){this.abruptCompletion_={jumpTo:t};this.nextAddress=this.finallyAddress_};$jscomp.generator.Context.prototype.yield=function(t,F){this.nextAddress=F;return{value:t}};
$jscomp.generator.Context.prototype.yieldAll=function(t,F){t=$jscomp.makeIterator(t);var C=t.next();$jscomp.generator.ensureIteratorResultIsObject_(C);if(C.done)this.yieldResult=C.value,this.nextAddress=F;else return this.yieldAllIterator_=t,this.yield(C.value,F)};$jscomp.generator.Context.prototype.jumpTo=function(t){this.nextAddress=t};$jscomp.generator.Context.prototype.jumpToEnd=function(){this.nextAddress=0};
$jscomp.generator.Context.prototype.setCatchFinallyBlocks=function(t,F){this.catchAddress_=t;void 0!=F&&(this.finallyAddress_=F)};$jscomp.generator.Context.prototype.setFinallyBlock=function(t){this.catchAddress_=0;this.finallyAddress_=t||0};$jscomp.generator.Context.prototype.leaveTryBlock=function(t,F){this.nextAddress=t;this.catchAddress_=F||0};
$jscomp.generator.Context.prototype.enterCatchBlock=function(t){this.catchAddress_=t||0;t=this.abruptCompletion_.exception;this.abruptCompletion_=null;return t};$jscomp.generator.Context.prototype.enterFinallyBlock=function(t,F,C){C?this.finallyContexts_[C]=this.abruptCompletion_:this.finallyContexts_=[this.abruptCompletion_];this.catchAddress_=t||0;this.finallyAddress_=F||0};
$jscomp.generator.Context.prototype.leaveFinallyBlock=function(t,F){F=this.finallyContexts_.splice(F||0)[0];if(F=this.abruptCompletion_=this.abruptCompletion_||F){if(F.isException)return this.jumpToErrorHandler_();void 0!=F.jumpTo&&this.finallyAddress_<F.jumpTo?(this.nextAddress=F.jumpTo,this.abruptCompletion_=null):this.nextAddress=this.finallyAddress_}else this.nextAddress=t};$jscomp.generator.Context.prototype.forIn=function(t){return new $jscomp.generator.Context.PropertyIterator(t)};
$jscomp.generator.Context.PropertyIterator=function(t){this.object_=t;this.properties_=[];for(var F in t)this.properties_.push(F);this.properties_.reverse()};$jscomp.generator.Context.PropertyIterator.prototype.getNext=function(){for(;0<this.properties_.length;){var t=this.properties_.pop();if(t in this.object_)return t}return null};$jscomp.generator.Engine_=function(t){this.context_=new $jscomp.generator.Context;this.program_=t};
...
$jscomp.generator.Engine_.prototype.return_=function(t){this.context_.start_();var F=this.context_.yieldAllIterator_;if(F)return this.yieldAllStep_("return"in F?F["return"]:function(C){return{value:C,done:!0}},t,this.context_.return);this.context_.return(t);return this.nextStep_()};
...
$jscomp.generator.Engine_.prototype.yieldAllStep_=function(t,F,C){try{var J=t.call(this.context_.yieldAllIterator_,F);$jscomp.generator.ensureIteratorResultIsObject_(J);if(!J.done)return this.context_.stop_(),J;var O=J.value}catch(B){return this.context_.yieldAllIterator_=null,this.context_.throw_(B),this.nextStep_()}this.context_.yieldAllIterator_=null;C.call(this.context_,O);return this.nextStep_()};
$jscomp.generator.Engine_.prototype.nextStep_=function(){for(;this.context_.nextAddress;)try{var t=this.program_(this.context_);if(t)return this.context_.stop_(),{value:t.value,done:!1}}catch(F){this.context_.yieldResult=void 0,this.context_.throw_(F)}this.context_.stop_();if(this.context_.abruptCompletion_){t=this.context_.abruptCompletion_;this.context_.abruptCompletion_=null;if(t.isException)throw t.exception;return{value:t.return,done:!0}}return{value:void 0,done:!0}};
$jscomp.generator.Generator_=function(t){this.next=function(F){return t.next_(F)};this.throw=function(F){return t.throw_(F)};this.return=function(F){return t.return_(F)};this[Symbol.iterator]=function(){return this}};$jscomp.generator.createGenerator=function(t,F){F=new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(F));$jscomp.setPrototypeOf&&t.prototype&&$jscomp.setPrototypeOf(F,t.prototype);return F};
$jscomp.asyncExecutePromiseGenerator=function(t){function F(J){return t.next(J)}function C(J){return t.throw(J)}return new Promise(function(J,O){function B(I){I.done?J(I.value):Promise.resolve(I.value).then(F,C).then(B,O)}B(t.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(t){return $jscomp.asyncExecutePromiseGenerator(t())};$jscomp.asyncExecutePromiseGeneratorProgram=function(t){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(t)))};
$jscomp.polyfill("Array.prototype.includes",function(t){return t?t:function(F,C){var J=this;J instanceof String&&(J=String(J));var O=J.length;C=C||0;for(0>C&&(C=Math.max(C+O,0));C<O;C++){var B=J[C];if(B===F||Object.is(B,F))return!0}return!1}},"es7","es3");$jscomp.polyfill("Promise.prototype.finally",function(t){return t?t:function(F){return this.then(function(C){return Promise.resolve(F()).then(function(){return C})},function(C){return Promise.resolve(F()).then(function(){throw C;})})}},"es9","es3");
$jscomp.iteratorFromArray=function(t,F){t instanceof String&&(t+="");var C=0,J=!1,O={next:function(){if(!J&&C<t.length){var B=C++;return{value:F(B,t[B]),done:!1}}J=!0;return{done:!0,value:void 0}}};O[Symbol.iterator]=function(){return O};return O};$jscomp.polyfill("Array.prototype.values",function(t){return t?t:function(){return $jscomp.iteratorFromArray(this,function(F,C){return C})}},"es8","es3");
var acapi=function(t){function F(a){function b(c,e){return c.reduce(function(d,g){var h;Array.isArray(g)&&(h=b(g,e+1));return h>d?h:d},e)}return b(a,1)}function C(a){if(void 0!=a){var b=[];if(/^(rgb|RGB)/.test(a)){a=a.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(",");for(var c of a)b.push(Number((Number(c)/255).toFixed(6)))}else/^#/.test(a)?a.includes("#")?(a=a.replace("#",""),3==a.length&&(a=a[0]+""+a[0]+a[1]+a[1]+a[2]+a[2]),6!=a.length?(console.error("\u975e\u5341\u516d\u8fdb\u5236\u989c\u8272\u683c\u5f0f"),
b=void 0):(b=parseInt(a.substring(0,2),16),c=parseInt(a.substring(2,4),16),a=parseInt(a.substring(4,6),16),b=[b/255,c/255,a/255])):(console.error("\u975e\u5341\u516d\u8fdb\u5236\u989c\u8272\u683c\u5f0f"),b=void 0):a instanceof Array&&(b=a);3==b.length&&b.push(1);return b}}function J(a){if(void 0!=a){var b,c=F(a);2==c?b=[[a]]:3==c?b=[a]:4==c&&(b=a);if(b)for(let e of b)for(let d of e)for(let g of d)2==g.length&&g.push(0);return b}}function O(a){if(void 0!=a)return 1==F(a)?[a]:a}function B(a){return a instanceof
...
GeoJSONLayer_UnHighlightFeature:565,GeoJSONLayer_FocusFeature:566,GeoJSONLayer_UnHighlightFeaturesByLayerId:568,ImageryLayer_Focus:567,ImageryLayer_AddCustom:569,VectorField_Show:570,VectorField_Hide:571,VectorField_Get:572,MarkerLayer_Add:573,MarkerLayer_Update:574,MarkerLayer_Delete:575,MarkerLayer_Clear:576,MarkerLayer_Focus:577,MarkerLayer_Show:578,MarkerLayer_ShowAll:579,MarkerLayer_Hide:580,MarkerLayer_HideAll:581,MarkerLayer_Get:582,MarkerLayer_FocusMarker:583,Settings_Update:585,GeoJSONLayer_Clear:584,
...
SplineMesh_Get:632,SplineMesh_Show:633,SplineMesh_Hide:634,SplineMesh_ShowAll:635,SplineMesh_HideAll:636,Marker_SetGatherStyle:638,Marker3D_Attach:639,SettingsPanel_setPak:640,TileLayer_EnableFluid:641,Tools_AddAnimation:642,Tools_EditAnimation:643,Tools_DeleteAnimation:644,Command_End:1E4},Ca=!1;(()=>{if(!Ca){Ca=!0;for(let a in k)k[k[a]]=a}})();class Qa{constructor(a,b){this.id=a;this.visible=b}}class Ra{constructor(a,b,c,e){this.id=a.toString();this.coordinate=b;this.radius=c;this.heatValue=e}}
class Sa{constructor(a,b,c,e,d,g,h,q,l,f,m,v,x,r){this.id=a.toString();this.coordinate=b;this.imagePath=c;this.imageSize=e;this.url=d;this.text=g;this.range=h||[1,1E5];this.showLine=!!q;this.textColor=l||[0,0,0,1];this.textBackgroundColor=f||[1,1,1,.85];this.textBorderColor=m||[0,0,0,0];this.textRange=v||1E5;this.hoverImagePath=x;this.autoHidePopupWindow=r||!0}}class Ta{constructor(a,b,c){this.url=a;this.width=b;this.height=c}}class Ua{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.coordinate=
b;this.contentURL=c.url;this.contentSize=[c.width,c.height];this.popupURL=e.url;this.popupSize=[e.width,e.height];this.pivot=d;this.range=g;this.autoHidePopupWindow=h||!0;this.popupPos=q}}class Va{constructor(a,b,c,e,d,g){this.id=a.toString();this.coordinates=J(b);this.color=C(c);this.heightRange=e;this.intensity=d;this.depthTest=g||!0}}class Wa{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.x=b;this.y=c;this.width=e;this.height=d;this.normalImage=g;this.hoverImage=h;this.tooltip=q}}class Xa{constructor(a,
b,c,e,d,g,h,q,l){this.id=a.toString();this.x=b;this.y=c;this.width=e;this.height=d;this.imageSequecePath=g;this.imageSequeceLength=h;this.loop=!!q;this.interactable=!!l}}class Ya{constructor(a,b,c,e,d,g,h){this.id=a.toString();this.duration=b;this.thickness=c;this.interval=e;this.velocity=d;this.color=C(g);this.coordinates=h}}class Za{constructor(a,b,c,e,d,g){this.id=a.toString();this.coordinate=b;this.radius=c;this.rippleNumber=e;this.color=C(d);this.brightness=g}}class $a{constructor(a,b,c,e,d,
g,h,q){this.id=a.toString();this.style=b;this.coordinates=J(c);this.color=C(e);this.height=d;this.intensity=g;this.tillingX=h;this.tillingY=q}}class ab{constructor(a,b,c,e,d,g,h,q,l,f){this.id=a.toString();this.color=C(b);this.coordinates=c;this.style=void 0==e?0:e;if(0>this.style||5<this.style)this.style=0;this.thickness=void 0==d?20:d;this.brightness=void 0==g?.5:g;this.flowRate=void 0==h?.5:h;this.tiling=q||0;this.depthTest=l||!0;this.shape=void 0==f?0:f}}class bb{constructor(a,b,c,e,d,g,h,q,l,
f,m,v,x,r,y,u,A){this.id=a.toString();this.color=C(b);this.coordinates=c;this.flowRate=void 0==e?.5:e;this.brightness=void 0==d?.5:d;this.bendDegree=void 0==g?.5:g;this.tiling=h||0;this.lineThickness=void 0==q?20:q;this.flowPointSizeScale=void 0==l?20:l;this.labelSizeScale=void 0==f?100:f;this.lineShape=void 0==m?1:m;this.lineStyle=v||0;this.flowShape=x||0;this.startPointShape=r||0;this.endPointShape=y||0;this.startLabelShape=u||0;this.endLabelShape=A||0;this.endLabelStyle=this.startLabelStyle=this.endPointStyle=
this.startPointStyle=this.flowStyle=0}}class cb{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.color=C(b);this.coordinates=J(c);this.framecolor=C(e);this.framethickness=d;this.depthTest=g||!0;this.brightness=h;this.style=q;if(0>this.style||10<this.style)this.style=0}}class db{constructor(a,b,c,e,d,g){this.id=a.toString();this.imagePath=b;this.coordinate=c;this.yaw=e;this.groupId=d||"";this.userData=g||""}}class eb{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.order=b;this.texturePath=
c;this.location=e;this.rotation=d;this.scale=g;this.groupId=h;this.userData=q}}class fb{constructor(a,b,c,e,d){this.id=a.toString();this.fileName=b;this.location=c;this.rotation=e;this.scale=d}}class gb{constructor(a,b,c,e,d,g,h){this.id=a;this.pakFilePath=b;this.assetPath=c;this.location=e;this.rotation=d;this.scale=g;this.smoothMotion=h}}class hb{constructor(a,b,c,e,d,g,h){this.id=a;this.tileLayerId=b;this.objectId=c;this.location=e;this.rotation=d;this.scale=g;this.smoothMotion=h}}class ib{constructor(a,
b,c,e,d,g,h){this.id=a;this.videoURL=b;this.location=c;this.rotation=e;this.fov=d;this.aspectRatio=g;this.distance=h}}class jb{constructor(a,b,c,e,d){this.id=a;this.coordinates=J(b);this.style=c;this.groupId=e;this.userData=d}}class kb{constructor(a,b,c,e,d){this.actorTag=a;this.objectName=b;this.functionName=c;this.paramType=e;this.paramValue=d}}class fa{constructor(a,b){this.tileLayerId=a;this.tileLayerActorNames=I(b)}}class lb{constructor(a,b,c,e){this.index=a;this.time=b;this.location=c;this.rotation=
e}}class mb{constructor(a,b,c){this.id=a.toString();this.name=b.toString();this.keyFrames=c}}class nb{constructor(){this.queue=[];this.dataMap=new Map}enqueue(a){if(null==a||void 0==a||!a.callbackIndex)return!1;this.queue.push(a.callbackIndex);this.dataMap.set(a.callbackIndex,a);return!0}dequeue(){if(0!=this.queue.length){const a=this.queue.shift();return this.dataMap.get(a)}}removeData(a){this.dataMap.has(a)&&this.dataMap.delete(a)}dataSize(){return this.dataMap.size}queueSize(){return this.queue.length}}
class ob extends nb{constructor(a){super();this.onSendAPI=a;this.timer=null;this.isMainThreadBusy=!1}onMainThreadBusy(a){this.isMainThreadBusy=a.busy}push(a){if(a.__noResponse)this.onSendAPI(a);else 0==this.dataSize()?(this.enqueue(a),this.callNext()):1E4<this.dataSize()?console.warn("The api queue has exceeded 10000, and subsequent calls will be ignored!"):this.enqueue(a)}callNext(a){a&&this.removeData(a);this.timer&&clearTimeout(this.timer);0!=this.dataSize()&&(a=this.dequeue())&&(this._callNextForTimeout(3E3),
this.onSendAPI(a))}_callNextForTimeout(a){this.timer=setTimeout(()=>{this.isMainThreadBusy?this._callNextForTimeout(5E3):this.callNext()},a)}}class M{constructor(a,b,c){this.int=a;this.type=b;this.colorProps=c;this._useBatchUpdate=!1;this._tempUpdateData=[]}_checkCommand(a){a=this.type+a;let b=k[a];void 0==b&&this.int.logWithColor("red",`Invalid command: ${a}`);return b}_convertFilePath(a){return this.int.resourcesPath?a.replace("@path:",this.int.resourcesPath+"/"):a}_processProps(a){a=B(a);for(var b of a)for(let e in b)if("string"==
typeof b[e]&&b[e].startsWith("@path:")&&(b[e]=this._convertFilePath(b[e])),"imagesArray"==e)for(let d=0;d<b[e].length;d++)b[e][d]=this._convertFilePath(b[e][d]);for(let e of a)"string"!=typeof e.id&&(e.id=e.id.toString());if(this.colorProps){b=this.colorProps.split("|");for(var c of a)for(let e of b)c.hasOwnProperty(e)&&(c[e]=C(c[e]))}if(-1!=["Polygon","Polygon3D","HighlightArea","DynamicWater"].indexOf(this.type))for(let e of a)e.coordinates=J(e.coordinates);for(let e of a)e.hasOwnProperty("userData")&&
...
y,u){if(!this._checkBBox(b))return this.int.logWithColor("red","Invalid bbox value"),!1;if("undefined"==typeof d||"function"==typeof d)return"function"==typeof d&&(u=d),this.int.call({command:k.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:B(e),style:-1},u);if(0==d||1==d){let A=-1E9,n=1E9;Array.isArray(y)&&(A=y[0],n=y[1]);return this.int.call({command:k.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:B(e),style:d,textureSize:g,opacityMode:h,opacityRange:q,blur:l,colors:f,blendMode:m,light:v,binaryFile:x,
updateTime:r,minVisibleHeight:A,maxVisibleHeight:n},u)}"function"==typeof d&&(u=d);return this.int.call({command:k.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:B(e),style:-1},u)}update(a,b,c,e,d,g,h,q,l,f,m,v,x,r,y,u){a={command:k.HeatMap_Update,id:a.toString()};b&&(this._checkBBox(b)||this.int.logWithColor("red","Invalid bbox value"),a.bbox=b);c&&(a.range=c);e&&(a.data=B(e));"undefined"!=typeof d&&"function"!=typeof d&&(g&&(a.textureSize=g),h&&(a.opacityMode=h),q&&(a.opacityRange=q),l&&(a.blur=
l),f&&(a.colors=f),m&&(a.blendMode=m),v&&(a.light=v),x&&(a.binaryFile=x),r&&(a.updateTime=r),y&&Array.isArray(y)?(a.minVisibleHeight=y[0],a.maxVisibleHeight=y[1]):(a.minVisibleHeight=-1E9,a.maxVisibleHeight=1E9));"function"==typeof d&&(u=d);return this.int.call(a,u)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}addPoints(a,b,c){return this.int.call({command:k.HeatMap_AddPoints,
id:a,data:B(b)},c)}removePoints(a,b,c){return this.int.call({command:k.HeatMap_RemovePoints,id:a,pointIds:B(b)},c)}setRange(a,b,c){return this.int.call({command:k.HeatMap_Update,id:a,range:b},c)}setBBox(a,b,c){return this._checkBBox(b)?this.int.call({command:k.HeatMap_Update,id:a,bbox:b},c):(this.int.logWithColor("red","Invalid bbox value"),!1)}}class Cb extends M{constructor(a){super(a,"HeatMap3D")}_checkBBox(a){if(a instanceof Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;
...
b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}queryVoxel(a,b,c){return this.int.call({command:k.HeatMap3D_Query,id:a,coordinate:b},c)}setDisplayMode(a,b,c){return this.int.call({command:k.HeatMap3D_Update,id:a,displayMode:b},c)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,viewportVisible:!!(b&Viewport.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});
e.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:k.HeatMap3D_SetViewPort,id:a,data:e},c)}}class Db extends M{constructor(a){super(a,"HighlightArea","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setColor(a,b,c){return super._updateOneProp(a,
"color",C(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setHeightRange(a,b,c){return super._updateOneProp(a,"heightRange",b,c)}setIntensity(a,b,c){return super._updateOneProp(a,"intensity",b,c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class Eb extends M{constructor(a){super(a,"HydrodynamicModel2")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setTime(a,b){return this.update(a,b)}startPlay(a,b){if(a instanceof Array){for(let c of a)c.playing=!0;return this.update(a,b)}return this.update({id:a.id,displayMode:a.displayMode,time:a.time,playing:!0},b)}stopPlay(a,b){if(a instanceof Array){let c=[];for(let e of a)a={},a.id=e,a.playing=!1,c.push(a);return this.update(c,b)}return this.update({id:a,playing:!1},
b)}pause(a,b){if(a instanceof Array){let c=[];for(let e of a)a={},a.id=e,a.paused=!0,c.push(a);return this.update(c,b)}return this.update({id:a,paused:!0},b)}resume(a,b){if(a instanceof Array){let c=[];for(let e of a)a={},a.id=e,a.paused=!1,c.push(a);return this.update(c,b)}return this.update({id:a,paused:!1},b)}}class Fb extends M{constructor(a){super(a,"Antenna")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Gb extends M{constructor(a){super(a,"HydroDynamic1D","arrowColor|waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,
b)}}class Hb extends M{constructor(a){super(a,"HydroDynamic2D","arrowColor|waterColor")}addByTif(a,b){this.add(a,b)}addBySdb(a,b){this.add(a,b)}addByBin(a,b){this.add(a,b)}addByShp(a,b){this.add(a,b)}_fixMarkerProperty(a,b){"add"==b&&(a.waterDepthAttributeName&&(a.waterDepth=a.waterDepthAttributeName),a.uvAttributeName&&(a.flowField=a.uvAttributeName),a.sdb&&(a.sdbFilePath=a.sdb),a.depthRange&&(a.valueRange=a.depthRange))}_fixMarkerData(a,b){if(a instanceof Array)for(let c of a)this._fixMarkerProperty(c,
b);else this._fixMarkerProperty(a,b)}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}update(a,b){this._fixMarkerData(a,"add");return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Ib extends M{constructor(a){super(a,"HydrodynamicModel","arrowColor|waterColor")}add(a,b){return super._add(a,b)}update(a,
b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Jb extends M{constructor(a){super(a,"ImageryLayer")}init(a,b){return this.int.call({command:k.ImageryLayer_Init,xmlPath:a.xmlUrl,layerName:a.layerName,tileMatrixName:a.tileMatrixName,ogcEPSG:a.ogcEPSG,cachePath:a.cachePath,mapMode:a.mapMode,renderMode:a.renderMode},
b)}add(a,b){const c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return a instanceof Array?new Promise(e=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;for(let g of a)if(d=yield c.addOne(g,b),0!=d.result){e(d);break}e(d)})):c.addOne(a,b)})}addOne(a,b){return this.int.call({command:k.ImageryLayer_Add,id:a.id,url:a.url,xmlPath:a.xmlPath,layerName:a.layerName,tileMatrixName:a.tileMatrixName,ogcEPSG:a.ogcEPSG},b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}setDrawOrder(a,b,c){return this.int.call({command:k.ImageryLayer_MoveImageLayerToAnotherBefore,id1:a,id2:b},c)}setDrawTop(a,b){return this.int.call({command:k.ImageryLayer_MoveImageLayerPrimary,id1:a},b)}setDrawBottom(a,b){return this.int.call({command:k.ImageryLayer_MoveImageLayerLast,id1:a},b)}addVTPK(a,b){return this.int.call({command:k.ImageryLayer_VTPK_Add,id:a},b)}deleteVTPK(a,b){return this.int.call({command:k.ImageryLayer_VTPK_Delete,
id:a},b)}setVTPKVisable(a,b,c){return this.int.call({command:k.ImageryLayer_VTPK_Visible,id:a,visible:b},c)}}class Kb extends M{constructor(a){super(a,"Light","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,
b){return super._get(a,b)}}class Lb extends M{constructor(a){super(a,"Marker","fontColor|fontOutlineColor|textBackgroundColor|lineColor")}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}_fixMarkerProperty(a,b){a.textColor&&(a.fontColor=a.textColor);a.url&&(a.popupURL=a.url);a.dispalyMode&&(a.displayMode=a.dispalyMode);R(a.displayMode)&&"add"==b&&(a.displayMode=4);a.popupURL&&!a.popupSize&&"add"==b&&(a.popupSize=[600,400]);0==a.showLine&&(a.lineSize=[0,0]);1!=a.showLine||null!=a.lineSize&&
...
"update");return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}showPopupWindow(a,b){return this.int.call({command:k.Marker_ShowPopupWindow,ids:I(a)},b)}hidePopupWindow(a,b){return this.int.call({command:k.Marker_HidePopupWindow,
ids:I(a)},b)}showAllPopupWindow(a){return this.int.call0(k.Marker_ShowAllPopupWindow,a)}hideAllPopupWindow(a){return this.int.call0(k.Marker_HideAllPopupWindow,a)}get(a,b){return super._get(a,b)}setGroupId(a,b,c){return super._updateOneProp(a,"groupId",b,c)}setUserData(a,b,c){return super._updateOneProp(a,"userData",b,c)}setAnchors(a,b,c){return this.setScreenOffset(a,b,c)}setScreenOffset(a,b,c){return super._updateOneProp(a,"anchors",b,c)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",
...
b){return this.int.call({command:k.Marker_SetupPOIAttachment,data:B(a)},b)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,viewportVisible:!!(b&Viewport.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:k.Marker_SetViewPort,id:a,data:e},c)}showByGroupId(a,b){return this.int.call({command:k.Marker_ShowByGroupId,ids:B(a)},b)}hideByGroupId(a,
b){return this.int.call({command:k.Marker_HideByGroupId,ids:B(a)},b)}deleteByGroupId(a,b){return this.int.call({command:k.Marker_DeleteByGroupId,ids:B(a)},b)}setClusterStyle(a,b){if(a)return this.int.call({command:k.Marker_SetGatherStyle,path:a.imagePath||"",drawSize:a.imageSize||[20,20],textSize:a.fontSize||12,textColor:C(a.fontColor)||[1,1,1,1]},b);console.error("\u6837\u5f0f\u5bf9\u8c61\u683c\u5f0f\u9519\u8bef!")}}class Mb extends M{constructor(a){super(a,"Marker3D","textColor|textOutlineColor")}add(a,
...
b,c)}setStartPointShape(a,b,c){return super._updateOneProp(a,"startPointShape",b,c)}setEndPointShape(a,b,c){return super._updateOneProp(a,"endPointShape",b,c)}setStartLabelShape(a,b,c){return super._updateOneProp(a,"startLabelShape",b,c)}setEndLabelShape(a,b,c){return super._updateOneProp(a,"endLabelShape",b,c)}}class Pb extends M{constructor(a){super(a,"Panorama")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}get(a,b){return super._get(a,b)}enter(a,b){return this.int.call({command:k.Panorama_Enter,ids:I(a)},b)}exit(a){return this.int.call({command:k.Panorama_Exit},a)}switchMode(a){return this.int.call({command:k.Panorama_Switch},a)}}class Qb extends M{constructor(a){super(a,"Polygon","color|frameColor")}add(a,b){this._fixPolygonData(a);return super._add(a,b)}_fixPolygonProperty(a){a.brightness=0==a.intensity||1==a.intensity?a.intensity:1;11==a.style&&(a.style=0,
...
"color",C(b),c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setAutoHeight(a,b,c){return super._updateOneProp(a,"autoHeight",b,c)}}class Ub extends M{constructor(a){super(a,"River","arrowColor|waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,
b)}}class Vb extends M{constructor(a){super(a,"ShapeFileLayer","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}_fix_property(a){if(a instanceof Array){let b=[];for(let c of a)R(c.cacheAllField)&&(c.cacheAllField=!1,b.push(c));a=b}else R(a.cacheAllField)&&(a.cacheAllField=!1);return a}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}get(a,b){return super._get(a,b)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,
b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}open(a,b){return this.int.call({command:k.ShapeFileLayer_OpenShapeFileLayer,data:B(a)},b)}highlightFeature(a,b,c){return this.int.call({command:k.ShapeFileLayer_HighlightFeature,data:B({shpId:a,featureIds:[b]})},c)}stopHighlightFeature(a,b,c){return this.int.call({command:k.ShapeFileLayer_UnHighlightFeature,data:B({shpId:a,featureIds:[b]})},c)}highlightFeatures(a,b){return this.int.call({command:k.ShapeFileLayer_HighlightFeature,
data:B(a)},b)}stopHighlightFeatures(a,b){return this.int.call({command:k.ShapeFileLayer_UnHighlightFeature,data:B(a)},b)}focusFeature(a,b,c,e,d,g){return this.int.call({command:k.ShapeFileLayer_FocusFeature,data:B({shpId:a,featureIds:[b]}),distance:c,flyTime:e,rotation:d},g)}getFeature(a,b){return this.int.call({command:k.ShapeFileLayer_GetFeatureInfo,data:B(a)},b)}}class Wb extends M{constructor(a){super(a,"SignalWave","olor")}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}_fixMarkerProperty(a,
...
b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Xb extends M{constructor(a){super(a,"SplineMesh")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,
b)}}class Yb extends M{constructor(a){super(a,"Tag","textColor|textBackgroundColor|textBorderColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,
...
viewportVisible:!!(b&Viewport.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:k.VectorField_SetViewPort,id:a,data:e},c)}}class bc extends M{constructor(a){super(a,"Vehicle","color")}add(a,b){this._fixVehicleData(a);return super._add(a,b)}_fixVehicleData(a){if(a instanceof Array)for(let b of a)this._fixVehicleProperty(b);else this._fixVehicleProperty(a)}_fixVehicleProperty(a){if(void 0===a.delay||null===a.delay||""===a.delay)a.delay=.5;0<a.colorType&&
R(a.color)?a.initFunctionInfos=[{functionName:"setVehicleColor",parameters:[{paramType:2,paramValue:a.colorType}]}]:a.colorType=0;a.color&&(a.initFunctionInfos=[{functionName:"setColor",parameters:[{paramType:6,paramValue:C(a.color)}]}])}update(a,b){this._fixVehicleData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d,g,h,q){return this.int.call({command:k.Vehicle_Focus,ids:B(a),distance:c||0,flyTime:e||2,rotation:d||[0,0,0],distanceRotation:g||
[0,0,0],followEnabled:b||!1,offset:h||[0,0,0],sensitivity:.02},q)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setWayPoint(a,b){return this.int.call({command:k.Vehicle_AddWayPoints,data:B(a)},b)}moveTo(a,b){return this.int.call({command:k.Vehicle_MoveTo,data:B(a)},b)}start(a,b){if(R(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(0<=a.timeStamp)a.active=!0;else if(a instanceof Array)for(let c of a)c.active=!0;else{console.error("\u53c2\u6570\u975e\u6cd5!");
return}return this.int.call({command:k.Vehicle_Update,data:B(a)},b)}}pause(a,b){a=this._fixIds(a,!1);if(!R(a))return this.int.call({command:k.Vehicle_Update,data:a},b)}resume(a,b){a=this._fixIds(a,!0);if(!R(a))return this.int.call({command:k.Vehicle_Update,data:a},b)}stop(a,b){a=this._fixIds(a,!1);if(!R(a))return this.int.call({command:k.Vehicle_Update,data:a},b)}_fixIds(a,b){let c=[];if(R(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(a instanceof Array){let e=!1;for(let d of a){if("string"!=
typeof d){e=!0;break}c.push({id:d,active:b})}if(e){console.error("\u53c2\u6570\u975e\u6cd5!");return}return c}if("string"!==typeof a||R(a))console.error("\u53c2\u6570\u975e\u6cd5!");else return c.push({id:a,active:b}),c}}callBatchFunction(a,b){return this.int.call({command:k.Vehicle_CallBatchFunction,data:B(a)},b)}}class cc extends M{constructor(a){super(a,"Vehicle2","color")}add(a,b){this._fixVehicleData(a);return super._add(a,b)}_fixVehicleData(a){if(a instanceof Array)for(let b of a)this._fixVehicleProperty(b);
else this._fixVehicleProperty(a)}_fixVehicleProperty(a){a.timeMode=1;if(void 0===a.delay||null===a.delay||""===a.delay)a.delay=.5;0<a.colorType&&R(a.color)?a.initFunctionInfos=[{functionName:"setVehicleColor",parameters:[{paramType:2,paramValue:a.colorType}]}]:a.colorType=0;a.color&&(a.initFunctionInfos=[{functionName:"setColor",parameters:[{paramType:6,paramValue:C(a.color)}]}])}update(a,b){this._fixVehicleData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}show(a,
b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}focus(a,b,c,e,d,g){R(e)&&(e=[0,0,0]);return this.int.call({command:k.Vehicle2_Focus,ids:B(a),followEnabled:!1,distance:b||5,flyTime:c||2,viewPitch:e[0]||0,viewYaw:e[1]||0,offset:d||[0,0,0],sensitivity:.02},g)}setFollow(a,b,c,e,d,g,h,q,l){return this.int.call({command:k.Vehicle2_Focus,ids:B(a),distance:b||0,flyTime:c||2,viewPitch:e||0,viewYaw:d||0,offset:q||[0,0,0],sensitivity:g||.02,viewControl:h||!1,followEnabled:!0},
l)}moveTo(a,b){return this.int.call({command:k.Vehicle2_MoveTo,data:B(a)},b)}showTextLabel(a,b,c){return R(b)?this.int.call({command:k.Vehicle2_AddMarker,ids:B(a),fontSize:12,fontOutlineSize:1,textBackgroundColor:[1,1,1,1],fontColor:[1,1,1,1],fontOutlineColor:[0,0,0,1],lineSize:1,lineColor:[0,0,0,1],lineOffset:[0,0]},c):this.int.call({command:k.Vehicle2_AddMarker,ids:B(a),text:b.text||B(a),fontSize:b.fontSize||12,fontOutlineSize:b.fontOutlineSize||1,textBackgroundColor:b.textBackgroundColor||[1,1,
1,1],fontColor:b.fontColor||[1,1,1,1],fontOutlineColor:b.fontOutlineColor||[0,0,0,1],lineSize:b.lineSize||1,lineColor:b.lineColor||[0,0,0,1],lineOffset:b.lineOffset||[0,0]},c)}hideTextLabel(a,b){return this.int.call({command:k.Vehicle2_ClearMarker,ids:B(a)},b)}callBatchFunction(a,b){return this.int.call({command:k.Vehicle_CallBatchFunction,data:B(a)},b)}}class dc extends M{constructor(a){super(a,"VideoProjection","frustumColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,
b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setVideoURL(a,b,c){return super._updateOneProp(a,"videoURL",b,c)}setLocation(a,b,c){return super._updateOneProp(a,"location",b,c)}setRotation(a,b,c){return super._updateOneProp(a,"rotation",b,c)}setFovy(a,b,c){return super._updateOneProp(a,"fov",b,c)}setAspectRatio(a,b,c){return super._updateOneProp(a,
"aspectRatio",b,c)}setDistance(a,b,c){return super._updateOneProp(a,"distance",b,c)}setDepthCulling(a,b,c){return super._updateOneProp(a,"depthCulling",b,c)}setFrustumColor(a,b,c){return super._updateOneProp(a,"frustumColor",b,c)}}class ec extends M{constructor(a){super(a,"WaterFlowField")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,
b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,viewportVisible:!!(b&Viewport.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:k.WaterFlowField_SetViewPort,id:a,data:e},c)}}class fc extends M{constructor(a){super(a,"WaterMesh","waterColor")}add(a,b){return super._add(a,
b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setIndices(a,b,c){return super._updateOneProp(a,"indices",b,c)}setNormals(a,b,c){return super._updateOneProp(a,
"normals",b,c)}setWaterColor(a,b,c){return super._updateOneProp(a,"waterColor",b,c)}setWaterSpeed(a,b,c){return super._updateOneProp(a,"waterSpeed",b,c)}setWaterUVRepeat(a,b,c){return super._updateOneProp(a,"waterUVRepeat",b,c)}setWaterDirection(a,b,c){return super._updateOneProp(a,"waterDirection",b,c)}setWaterWaveScale(a,b,c){return super._updateOneProp(a,"waveScale",b,c)}}var Ea="en",wa={},Fa={VersionMismatch:["\u8b66\u544a\uff1a\n--------------------------------------------------\n    ac.min.js\u6587\u4ef6\u7248\u672c\uff08{0}\uff09\u548c\u4e91\u6e32\u67d3\u670d\u52a1\u5668\u7248\u672c\uff08{1}\uff09\u4e0d\u4e00\u81f4\uff0c\n    \u53ef\u80fd\u9020\u6210\u63a5\u53e3\u8c03\u7528\u9519\u8bef\u6216\u5d29\u6e83\uff0c\u8bf7\u786e\u8ba4!",
...
b){this._check();ue.internal.execute("setItem",a,b)}static getData(a){this._check();return ue.internal.execute("getItem",a)}static showTickWindow(a){this._check();return ue.internal.showtickwindow(a)}static close(){this._check();return ue.internal.closewindow()}static postEvent(a){this._check();ue.internal.postevent(a)}}"object"==typeof window&&(window.FdExternal=sa);class gc{constructor(a){this.int=a;this._useOldDataFormat=!1}useOldDataFormat(a){this._useOldDataFormat=a||!0}get(a){return this.int.call0(k.Camera_GetCamera,
...
typeof h&&(q=h,h=void 0);if(this._useOldDataFormat){let l=d;d=g;g=l}return this.int.call({command:k.Camera_Set,coordinate:[a,b,c],distance:e,pitch:d||0,yaw:g||0,flyTime:h},q)}lookAtBBox(a,b,c,e,d){"function"==typeof e&&(d=e,e=void 0);if(this._useOldDataFormat){let g=b;b=c;c=g}return this.int.call({command:k.Camera_LookAtBBox,bbox:a,pitch:b||0,yaw:c||0,flyTime:e},d)}playAnimation(a,b){return this.int.call({command:k.Camera_PlayAnimation,id:a},b)}stopAnimation(a){return this.int.call0(k.Camera_StopAnimation,
a)}pauseAnimation(a){return this.int.call0(k.Camera_PauseAnimation,a)}resumeAnimation(a){return this.int.call0(k.Camera_ResumeAnimation,a)}getAnimationList(a){return this.int.call0(k.Camera_GetAnimationList,a)}getAnimationImage(a,b){return this.int.call({command:k.Camera_GetAnimationImage,name:a},b)}moveForward(a){return this.int.call({command:k.Camera_Move,moveForward:!0},a)}moveBackward(a){return this.int.call({command:k.Camera_Move,moveBackward:!0},a)}moveLeft(a){return this.int.call({command:k.Camera_Move,
moveLeft:!0},a)}moveRight(a){return this.int.call({command:k.Camera_Move,moveRight:!0},a)}moveUp(a){return this.int.call({command:k.Camera_Move,moveUp:!0},a)}moveDown(a){return this.int.call({command:k.Camera_Move,moveDown:!0},a)}turnLeft(a){return this.int.call({command:k.Camera_Move,turnLeft:!0},a)}turnRight(a){return this.int.call({command:k.Camera_Move,turnRight:!0},a)}turnUp(a){return this.int.call({command:k.Camera_Move,turnUp:!0},a)}turnDown(a){return this.int.call({command:k.Camera_Move,turnDown:!0},
a)}stop(a){return this.int.call({command:k.Camera_Move,stop:!0},a)}getEulerAngle(a,b){const c=360/(2*Math.PI);let e=b[0]-a[0],d=b[1]-a[1];return[Math.atan2(b[2]-a[2],Math.sqrt(e*e+d*d))*c,Math.atan2(e,d)*c-90,0]}lockByBBox(a,b){return this.int.call({command:k.Camera_LockBBox,bbox:a},b)}unlock(a){return this.int.call({command:k.Camera_UnLockBBox},a)}flyAround(a,b,c,e,d){return this.int.call({command:k.Camera_FlyAround,coordinate:a,rotation:b||[0,90,0],distance:c||1E3,time:e||10},d)}enterWorld(a){return this.int.call({command:k.Camera_ExitWorldAnimation},
a)}exitWorld(a){return this.int.call({command:k.Camera_EnterWorldAnimation},a)}cancelFollow(a){return this.int.call({command:k.Camera_CancelFollow},a)}}class hc{constructor(a){this.int=a}screen2World(a,b,c){return this.int.call({command:k.Coord_Screen2World,screenPosition:[a,b]},c)}world2Screen(a,b,c,e){return this.int.call({command:k.Coord_World2Screen,worldlocation:[a,b,c]},e)}gcs2pcs(a,b,c){"function"==typeof b&&(c=b);R(b)&&(b=1);if(1==b)return this.int.call({command:k.Coord_GCS2PCS,coordinates:O(a)},
c);2==b?this.transform(O(a),2,0,c):3==b?this.transform(O(a),3,0,c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}pcs2gcs(a,b,c){"function"==typeof b&&(c=b);R(b)&&(b=1);if(1==b)return this.int.call({command:k.Coord_PCS2GCS,coordinates:O(a)},c);2==b?this.transform(O(a),0,2,c):3==b?this.transform(O(a),0,3,c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}transform(a,b,c,e){return this.int.call({command:k.Coord_Transform,coordinates:O(a),src:b,dest:c},e)}}class ic{constructor(a){this.int=
a}start(a){return this.int.call0(k.EditHelper_Start,a)}cancel(a){return this.int.call0(k.EditHelper_Quit,a)}finish(a,b){return this.int.call({command:k.EditHelper_Finish,withOffset:a||!0},b)}setParam(a,b,c,e){return this.int.call({command:k.EditHelper_SetParam,lineType:a,buildType:b,color:C(c)},e)}}class jc{constructor(a){this.int=a}setVisibility(a,b){return this.int.call({command:k.InfoTree_SetVisibility,layers:B(a)},b)}show(a,b){return this.int.call({command:k.InfoTree_Show,ids:I(a)},b)}hide(a,
b){return this.int.call({command:k.InfoTree_Hide,ids:I(a)},b)}enableXRay(a,b,c){return this.int.call({command:k.InfoTree_EnableXRay,ids:B(a),color:C(b)},c)}disableXRay(a,b){return this.int.call({command:k.InfoTree_DisableXRay,ids:B(a)},b)}showByGroupId(a,b){return this.int.call({command:k.InfoTree_ShowByGroupId,ids:I(a)},b)}hideByGroupId(a,b){return this.int.call({command:k.InfoTree_HideByGroupId,ids:I(a)},b)}highlightByGroupId(a,b){return this.int.call({command:k.InfoTree_HighlightByGroupId,ids:I(a)},
b)}deleteByGroupId(a,b){return this.int.call({command:k.InfoTree_DeleteByGroupId,ids:I(a)},b)}get(a){return this.int.call0(k.InfoTree_Get,a)}focus(a,b){return this.int.call({command:k.InfoTree_Focus,ids:I(a)},b)}getBPFunction(a,b){return this.int.call({command:k.InfoTree_GetProjectTreeBPFunction,ids:B(a)},b)}callBPFunction(a,b){return this.int.call({command:k.InfoTree_CallProjectTreeBPFunction,data:B(a)},b)}}class kc{constructor(a){this.int=a;this.apiVersion="6.1";this.apiVersionServer=""}isApiVersionMatched(){let a=
this.apiVersionServer,b=this.int.getVersion();return"1.0.0"==this.apiVersionServer||a==b||a&&b&&a.substring(0,a.lastIndexOf("."))==b.substring(0,b.lastIndexOf("."))?!0:!1}addImageButtons(a,b){return this.int.call({command:k.Misc_AddImageButton,data:B(a)},b)}deleteImageButtons(a,b){return this.int.call({command:k.Misc_DeleteImageButton,ids:I(a)},b)}addAnimatedImageButtons(a,b){return this.int.call({command:k.Misc_AddAnimatedImageButton,data:B(a)},b)}setApiVersionReceived(a){this.int.onApiVersionReceived=
a}playVideo(a,b,c,e,d,g,h){return this.int.call({command:k.Misc_PlayVideo,data:[{id:a.toString(),position:[b,c],size:[e,d],url:g}]},h)}stopPlayVideo(a,b){return this.int.call({command:k.Misc_StopPlayVideo,ids:I(a)},b)}playMovie(a,b,c){"function"==typeof b&&(c=b,b=!1);return this.int.call({command:k.Misc_PlayMovie,loop:b,url:a},c)}stopMovie(a){return this.int.call({command:k.Misc_StopMovie},a)}playVideoAlone(a,b,c){let e=[];e.push(`--URL=${a}`);"object"==typeof b&&(b.hasOwnProperty("mute")&&b.mute&&
...
e.push("--HideBuffering"),b.hasOwnProperty("maximizeBox")&&b.maximizeBox&&e.push("--MaximizeBox"),b.hasOwnProperty("notTopmost")&&b.notTopmost&&e.push("--NotTopmost"));a=e.join(" ");return this.startProcess("$VlcPlayer",a,!0,c)}stopPlayVideoAlone(a,b){return this.int.test(2,a,b)}setWindowResolution(a,b,c){return this.int.call({command:k.Misc_SetWindowResolution,cx:a,cy:b,mode:0},c)}callBPFunction(a,b){return this.int.call({command:k.Misc_CallBPFunction,data:B(a)},b)}enterReportMode(a){return this.int.call0(k.Misc_EnterReportMode)}exitReportMode(a){return this.int.call0(k.Misc_ExitReportMode,
a)}showAllFoliages(a){return this.int.call0(k.Misc_ShowAllFoliages,a)}hideAllFoliages(a){return this.int.call0(k.Misc_HideAllFoliages,a)}startProcess(a,b,c,e){"function"==typeof c&&(e=c,c=!0);return this.int.call({command:k.Misc_StartProcess,appName:a,commandLine:b,visible:c},e)}enterMultiViewportMode(a,b,c,e){if(null==b||void 0==b)b="#DEA309";if(null==c||void 0==c)c=2;return this.int.call({command:k.Misc_EnterMultiViewport,type:a,lineColor:C(b),lineThickness:c},e)}exitMultiViewportMode(a){return this.int.call({command:k.Misc_ExitMultiViewport},
a)}setActiveViewport(a,b){return this.int.call({command:k.Misc_SetActivateMultiViewport,viewIndex:B(a)},b)}getActiveViewport(a){return this.int.call({command:k.Misc_GetActivateMultiViewport},a)}setMultiviewportInteractSync(a,b){this.setCameraFollow4Viewport(a,b)}setCameraFollow4Viewport(a,b){return this.int.call({command:k.Misc_UpdateMultiViewport,moverTogether:a},b)}downloadPakFiles(a,b){return this.int.call({command:k.Misc_downloadPakFiles,ids:B(a)},b)}getConvexPolygon(a,b){return this.int.call({command:k.Misc_ConvexHull2D,
data:B(a)},b)}getMaterial(a,b){return this.int.call({command:k.Misc_QueryActorOrMaterial,idOrPaths:B(a)},b)}getBPFunction(a,b){return this.int.call({command:k.Misc_QueryActorOrMaterial,idOrPaths:B(a)},b)}reloadPak(a){return this.int.call({command:k.Misc_ReloadPak},a)}projectAssetCount(a,b){return this.int.call({command:k.Misc_ProjectAssetCount,type:a},b)}projectAssetCountAll(a){return this.int.call({command:k.Misc_ProjectAssetCount,type:0},a)}switchShortcutKey(a,b){return this.int.call({command:k.Misc_SwitchShortcutKey,
"switch":a},b)}startPolygonClip(a,b,c){return this.int.tools.startPolygonClip(a,b,c)}stopClip(a){return this.int.tools.stopClip(a)}playAnimation(a,b){return this.int.camera.playAnimation(a,b)}stopAnimation(a){return this.int.camera.stopAnimation(a)}setDateTime(a,b,c,e,d,g,h){return this.int.weather.setDateTime(a,b,c,e,d,g,h)}setQueryToolState(a,b){return this.int.call({"c.ommand":k.Settings_SetMousePickMask,mouseClick:a},b)}setCampassVisible(a,b){return this.int.settings.setCampassVisible(a,b)}setMainUIVisibility(a,
...
0,renderMode:b.renderMode||0,decalMode:b.decalMode||1,serverURL:b.serverURL,coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(k.Settings_GetMapMode,a)}setWMTSLayerVisible(a,b){this.setwmtsLayerVisible(a,b)}setwmtsLayerVisible(a,b){return this.int.call({command:k.Settings_SetWMTSLayerVisible,data:B(a)},b)}setWMTSLayerOpacity(a,b){return this.int.call({command:k.Settings_SetWMTSLayerOpacity,data:B(a)},b)}setMapURL(a,b){return this.int.call({command:k.Settings_SetMapURL,
url:a},b)}highlightColor(a,b){return this.setHighlightColor(a,b)}setHighlightColor(a,b){return this.int.call({command:k.Settings_SetHighlightColor,color:C(a)},b)}setFovX(a,b){return this.int.call({command:k.Settings_SetFovX,value:a},b)}setOceanColor(a,b){return this.int.call({command:k.Settings_SetOceanColor,color:C(a)},b)}setEnableInteract(a,b){if(this.int.player)this.int.player.setEnableInteract(a);else return this.int.call({command:k.Settings_SetEnableInteract,enableInteract:a},b)}setInteractiveMode(a,
b){return this.int.call({command:k.Settings_SetInteractiveMode,mode:a},b)}setCharacterRoaming(a,b,c,e){return this.int.call({command:k.Settings_SetInteractiveMode,mode:1,location:a,rotation:b,targetArmLength:c},e)}getInteractiveMode(a){return this.int.call({command:k.Settings_GetInteractiveMode},a)}setCampassVisible(a,b){return this.int.call({command:k.Settings_SetCampassVisible,visible:a},b)}setCampassPosition(a,b,c){return this.int.call({command:k.Settings_SetCampassPosition,position:[a,b]},c)}setMainUIVisibility(a,
b){return this.int.call({command:k.Settings_SetMainUIVisibility,visible:a},b)}setMousePickMask(a,b){let c=!1,e=!1,d=!1;a&ra.MouseClick&&(c=!0);a&ra.MouseMove&&(e=!0);a&ra.MouseHover&&(d=!0);return this.int.call({command:k.Settings_SetMousePickMask,mouseClick:c,mouseMove:e,mouseHover:d},b)}setTerrainAlpha(a,b){return this.int.call({command:k.Settings_SetTerrainAlpha,alpha:a},b)}setEnableCameraMovingEvent(a,b,c){R(b)&&(b=20);return this.int.call({command:k.Settings_EnableCameraMovingEvent,bEnable:a,
monitorThreshold:b},c)}setLabelLayer(a,b){return this.int.call({command:k.VTPKService_Set,vtpk:a},b)}getLabelLayer(a){return this.int.call({command:k.VTPKService_Get},a)}removeLabelLayer(a){return this.int.call({command:k.VTPKService_Set,vtpk:""},a)}setRenderedCursorVisible(a,b){this.setCursorAutoSync(a,b)}setCursorAutoSync(a,b){return this.int.call({command:k.Settings_CursorAutoSync,useSoftwareCursor:a},b)}setScreenControlsVisible(a,b){return this.int.call({command:k.Settings_SetGameBoardVisible,
visible:a},b)}getProjectWKT(a){return this.int.call({command:k.Settings_GetWKT},a)}setCharacterRotation(a,b){return this.int.call({command:k.Settings_SetCharacterRotation,rotation:a},b)}setGroundHeight(a,b){this.setGlobalHeight(a,b)}setGlobalHeight(a,b){return this.int.call({command:k.Settings_Update,height:a},b)}setLabelLayerScale(a,b){return this.int.call({command:k.Settings_Update,symbolSize:a},b)}setImageLayerEnableDecal(a,b){return this.int.call({command:k.Settings_Update,receiveDecalMode:a},
b)}}class mc{constructor(a){this.int=a}setReportMode(a,b,c,e){return this.int.call({command:k.Settings_SetReport,alignment:a,playMode:b,moveInOtherView:c},e)}getReportMode(a){return this.int.call({command:k.Settings_GetReport},a)}setControlMode(a,b,c,e,d){return this.int.call({command:k.Settings_SetControl,speed:a,yawSpeed:b,rotateSelf:c,useFemale:e},d)}getControlMode(a){return this.int.call({command:k.Settings_GetControl},a)}setPostProcessMode(a,b){let c=1E3,e=1E3;0<=a.terrainGlobalAlpha&&1>=a.terrainGlobalAlpha&&
(c=1E3*a.terrainGlobalAlpha);0<=a.osgbGlobalAlpha&&1>=a.osgbGlobalAlpha&&(e=1E3*a.osgbGlobalAlpha);return this.int.call({command:k.Settings_SetPostProcess,globalIllumination:a.globalIllumination,chromaticAberration:a.chromaticAberration,ambientRadius:a.ambientRadius,ambientFadeDistance:a.ambientFadeDistance,exposureEnabled:a.exposureEnabled,exposureCompensation:a.exposureCompensation,depthFiethSwitch:a.depthFiethSwitch,focalLength:a.focalLength,aperture:a.aperture,deepBlur:a.deepBlur,contrast:a.contrast,
saturation:a.saturation,lensFlareIntensity:a.lensFlareIntensity,ambientIntensity:a.ambientIntensity,bloomIntensity:a.bloomIntensity,lutMode:a.lutMode,lutIntensity:a.lutIntensity,darkCorner:a.darkCorner,screenPercentage:a.screenPercentage,terrainGlobalAlpha:c,terrainGlobalLitStatus:a.terrainGlobalLitStatus,osgbGlobalLitStatus:a.osgbGlobalLitStatus,osgbGlobalAlpha:e,antiAliasing:a.antiAliasing,tonemapper:a.tonemapper,postProcessEffects:a.postProcessEffects,dofMode:a.dofMode,wireThickness:a.wireThickness,
receiveDecalMode:a.receiveDecalMode},b)}getPostProcessMode(a){return this.int.call({command:k.Settings_GetPostProcess},a)}setCameraMode(a,b,c,e,d){e&&"function"==typeof e&&(d=e);return this.int.call({command:k.Settings_SetCamera,nearClipPlane:a,fovH:b,minCamHeight:c,maxCamHeight:e},d)}getCameraMode(a){return this.int.call({command:k.Settings_GetCamera},a)}setMapMode(a,b,c){b=b||{};return this.int.call({command:k.Settings_SetMapMode,mode:a,serviceType:b.serviceType||0,serviceProvider:b.serviceProvider||
0,coordType:b.coordType||0,mapPoint:b.mapPoint||[0,0],longitude:b.longitude||0,latitude:b.latitude||0,cache:b.cache||":memory:",style:b.style||"mapbox://styles/mapbox/streets-v10",groundHeight:b.groundHeight||0,renderMode:b.renderMode||0,decalMode:b.decalMode||1,serverURL:b.serverURL,coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(k.Settings_GetMapMode,a)}setPakFile(a,b){return this.int.call({command:k.SettingsPanel_setPak,bFolder:!1,pakFile:B(a)},b)}setPakFolder(a,
b){return this.int.call({command:k.SettingsPanel_setPak,bFolder:!0,pakFolder:B(a)},b)}}class nc{constructor(a){this.int=a}startPolygonClip(a,b,c){return this.int.call({command:k.Tools_StartPolygonClip,data:B({id:"0",coordinates:J(a),toggleImageCut:b})},c)}startPlaneClip(a,b,c,e,d){return this.int.call({command:k.Tools_StartPlaneClip,location:a,rotation:b,isShowPlane:c,isEdit:e},d)}startVolumeClip(a,b,c,e,d,g){return this.int.call({command:k.Tools_StartVolumeClip,bbox:a,rotation:d,value:b,isShowPlane:c,
isEdit:e},g)}updateVolumeClip(a,b,c,e,d,g){return this.int.call({command:k.Tools_UpdateVolumeClip,bbox:a,rotation:d,value:b,isShowPlane:c,isEdit:e},g)}stopClip(a){return this.stopPolygonClip(a)}stopPolygonClip(a){return this.int.call0(k.Tools_StopClip,a)}stopPlaneClip(a){return this.int.call({command:k.Tools_StopPlaneClip},a)}stopVolumeClip(a){return this.int.call({command:k.Tools_StopVolumeClip},a)}setMeasurement(a,b,c){b=b||{};return this.int.call({command:k.Tools_SetMeasurement,type:a,pointSize:b.pointSize,
textSize:b.textSize,textColor:C(b.textColor),pointColor:C(b.pointColor),lineColor:C(b.lineColor),areaColor:C(b.areaColor),showCoordinateText:b.showCoordinateText},c)}startMeasurement(a){return this.int.call0(k.Tools_StartMeasurement,a)}stopMeasurement(a){return this.int.call0(k.Tools_StopMeasurement,a)}lineIntersect(a,b,c){return this.int.call({command:k.Tools_LineIntersect,data:[{start:a,end:b}],highPrecision:!1,returnDetails:!0},c)}linesIntersect(a,b,c,e){return this.int.call({command:k.Tools_LineIntersect,
data:B(a),highPrecision:b,returnDetails:c},e)}startGeometryEdit(a,b,c){return this.int.call({command:k.Tools_StartGeometryEdit,id:a,type:b},c)}stopGeometryEdit(a){return this.int.call0(k.Tools_StopGeometryEdit,a)}startSkylineAnalysis(a,b){a=a||{};a.outlineColor&&(a.outlineColor=C(a.outlineColor));a.sceneColor&&(a.sceneColor=C(a.sceneColor));a.skylineColor&&(a.skylineColor=C(a.skylineColor));a.backgroundColor&&(a.backgroundColor=C(a.backgroundColor));if(a.tileLayers){a.tileLayers=B(a.tileLayers);for(let c of a.tileLayers)c.hasOwnProperty("color")&&
(c.color=C(c.color))}a.command=k.Tools_StartSkylineAnalysis;return this.int.call(a,b)}stopSkylineAnalysis(a){return this.int.call0(k.Tools_StopSkylineAnalysis,a)}exportSkyline(a,b,c,e){c=c||{};c.skylineColor&&(c.skylineColor=C(c.skylineColor));c.backgroundColor&&(c.backgroundColor=C(c.backgroundColor));if(c.tileLayers){c.tileLayers=B(c.tileLayers);for(let d of c.tileLayer)d.hasOwnProperty("color")&&(d.color=C(d.color))}return this.int.call({command:k.Tools_ExportSkyline,path:a,size:b,skylineColor:c.skylineColor,
backgroundColor:c.backgroundColor},e)}startViewshedAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=k.Tools_StartViewshedAnalysis;return this.int.call(a,b)}stopViewshedAnalysis(a){return this.int.call0(k.Tools_StopViewshedAnalysis,a)}startVisiblityAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=k.Tools_StartVisiblityAnalysis;
return this.int.call(a,b)}stopVisiblityAnalysis(a){return this.int.call0(k.Tools_StopVisiblityAnalysis,a)}startViewDomeAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=k.Tools_StartViewDomeAnalysis;return this.int.call(a,b)}stopViewDomeAnalysis(a){return this.int.call0(k.Tools_StopViewDomeAnalysis,a)}startCutFillAnalysis(a,b){a=a||{};a.cutLineColor&&(a.cutLineColor=C(a.cutLineColor));a.fillLineColor&&(a.fillLineColor=
C(a.fillLineColor));a.cutPointColor&&(a.cutPointColor=C(a.cutPointColor));a.fillPointColor&&(a.fillPointColor=C(a.fillPointColor));a.gridColor&&(a.gridColor=C(a.gridColor));a.command=k.Tools_StartCutFillAnalysis;return this.int.call(a,b)}stopCutFillAnalysis(a){return this.int.call0(k.Tools_StopCutFillAnalysis,a)}startSunshineAnalysis(a,b){var c=/^(0?[0-9]|1[0-9]|[2][0-3]):(0?[0-9]|[1-5][0-9])$/;if(null==a||void 0==a)console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a");else{let e=a.startTime,d=a.endTime;
...
return}if(a.startMinute>a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u5927\u4e8e\u7ed3\u675f\u65f6\u95f4");return}}!R(a.groundElevation)&&za(a.groundElevation)&&(a.undersideHeight=a.groundElevation,delete a.groundElevation);a.command=k.Tools_StartSunshineAnalysis;return this.int.call(a,b)}else console.error("\u53c2\u6570endTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");else console.error("\u53c2\u6570startTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");else console.error("\u65f6\u95f4\u53c2\u6570\u683c\u5f0f\u4e0d\u6b63\u786e")}}stopSunshineAnalysis(a){return this.int.call0(k.Tools_StopSunshineAnalysis,
a)}startTerrainSlopeAnalysis(a,b){a.command=k.Tools_StartTerrainSlopeAnalysis;a.arrowColor=C(a.arrowColor);return this.int.call(a,b)}stopTerrainSlopeAnalysis(a){return this.int.call0(k.Tools_StopTerrainSlopeAnalysis,a)}startContourLineAnalysis(a,b){a.command=k.Tools_StartContourLineAnalysis;a.contourLineColor=C(a.contourLineColor);return this.int.call(a,b)}stopContourLineAnalysis(a){return this.int.call0(k.Tools_StopContourLineAnalysis,a)}startFloodFill(a,b){a=a||{};a.color&&(a.color=C(a.color));
a.command=k.Tools_StartFloodFill;return this.int.call(a,b)}stopFloodFill(a){return this.int.call0(k.Tools_StopFloodFill,a)}replaceTextureByVideo(a,b,c){return this.int.call({command:k.Tools_ReplaceTexture,texturePackage:a,newTexture:b,type:1},c)}replaceTextureByImage(a,b,c){return this.int.call({command:k.Tools_ReplaceTexture,texturePackage:a,newTexture:b,type:2},c)}replaceTextureByUrl(a,b,c){return this.int.call({command:k.Tools_ReplaceTexture,texturePackage:a,newTexture:b,type:3},c)}restoreTexture(a,
b){return this.int.call({command:k.Tools_RestoreTexture,ids:B(a)},b)}showPanel(a,b,c){this.showAnalysisPanel(a,b,c)}hidePanel(a){this.hideAnalysisPanel(a)}showAnalysisPanel(a,b,c){return this.int.call({command:k.Tools_AnalysisPopupAttributes,type:a,position:b},c)}hideAnalysisPanel(a){return this.int.call({command:k.Tools_AnalysisCloseAttributes},a)}showUIPanel(a,b,c){return this.int.call({command:k.Tools_FunctionNavBar,type:a,position:b},c)}hideUIPanel(a,b){return this.int.call({command:k.Tools_HideFunctionNavBar,
type:a},b)}getUIPanel(a,b){return this.int.call({command:k.Tools_GetFunctionNavBar,type:a},b)}}class oc{constructor(a){this.int=a}getParams(a){return this.int.call0(k.Weather_GetParams,a)}_setParam(a,b){return this.int.call({command:k.Weather_SetParams,data:a},b)}setDateTime(a,b,c,e,d,g,h){return this.int.call({command:k.Weather_SetDate,year:a,month:b,day:c,hour:e,minute:d,daynightLoop:g},h)}getDateTime(a){return this.int.call0(k.Weather_GetDate,a)}simulateTime(a,b,c,e){let d=0,g=0,h=0,q=0;a instanceof
Array?(0<a.length&&(d=a[0]),1<a.length&&(g=a[1])):d=parseInt(a);b instanceof Array?(0<b.length&&(h=b[0]),1<b.length&&(q=b[1])):h=parseInt(b);return this.int.call({command:k.Weather_SimulateTime,startHour:d,startMinute:g,endHour:h,endMinute:q,duration:c},e)}setCloudThickness(a,b){return this.int.call({command:k.Weather_SetParams,lowCloudHeight:a},b)}setCloudDensity(a,b){return this.int.call({command:k.Weather_SetParams,lowCloudDensity:a},b)}setCloudHeight(a,b){return this.int.call({command:k.Weather_SetParams,
cloudHeight:a},b)}setRainParam(a,b,c,e,d,g,h){e&&"function"==typeof e&&(h=e);return this.int.call({command:k.Weather_SetParams,rainSnow:1,rainSnowStrength:a,rainSnowSpeed:b,raindropSize:c,rainSnowSize:c||null,rainSnowCamMotionAlignmentScale:d||null,rainSnowColor:e||null,rainSnowOvercastStrength:g||null},h)}setSnowParam(a,b,c,e,d,g,h){e&&"function"==typeof e&&(h=e);return this.int.call({command:k.Weather_SetParams,rainSnow:2,rainSnowStrength:a,rainSnowSpeed:b,snowflakeSize:c,rainSnowSize:c||null,rainSnowCamMotionAlignmentScale:d||
null,rainSnowColor:e||null,rainSnowOvercastStrength:g||null},h)}disableRainSnow(a){return this.int.call({command:k.Weather_SetParams,rainSnow:0},a)}setFogParam(a,b,c,e,d,g){return this.int.call({command:k.Weather_SetParams,fogDensity:a,fogColor:b,fogHeightFalloff:c,fogStartDistance:e,fogOpacity:d},g)}setSunIntensity(a,b){return this.int.call({command:k.Weather_SetParams,sunIntensity:a},b)}setMoonIntensity(a,b){return this.int.call({command:k.Weather_SetParams,moonIntensity:a},b)}setAmbientLightIntensity(a,
b){return this.int.call({command:k.Weather_SetParams,ambientLightIntensity:a},b)}setTemperature(a,b){return this.int.call({command:k.Weather_SetParams,temperature:a},b)}setShadowIntensity(a,b){return this.int.call({command:k.Weather_SetParams,shadowIntensity:a},b)}setShadowQuality(a,b){return this.int.call({command:k.Weather_SetParams,shadowQuality:a},b)}setShadowDistance(a,b){return this.int.call({command:k.Weather_SetParams,shadowDistance:a},b)}setDarkMode(a,b){return this.int.call({command:k.Weather_SetParams,
darkMode:!!a},b)}setSunSize(a,b){return this.int.call({command:k.Weather_SetParams,sunSize:a},b)}setMoonSize(a,b){return this.int.call({command:k.Weather_SetParams,moonSize:a},b)}setSkyVisibleMaxHeight(a,b){return this.int.call({command:k.Weather_SetParams,atmosphereVisibleHeight:a||1E5},b)}setCloudParam(a,b,c,e){return this.int.call({command:k.Weather_SetParams,cloudsColor:C(a),cloudsAltitude:b,cloudShadowStrength:c},e)}setLowCloud(a,b,c,e,d,g){return this.int.call({command:k.Weather_SetParams,lowCloudCoverage:a,
lowCloudDensity:b,lowCloudHeight:c,lowCloudWindSpeed:e,lowCloudWindDirection:d},g)}setHighCloud(a,b,c,e,d,g,h){return this.int.call({command:k.Weather_SetParams,highCloudLayerCoverage:a,highCloudWindSpeed:b,highCloudWindDirection:c,cirrusCloudDensity:e,cirrostratusCloudDensity:d,cirrocumulusCloudDensity:g},h)}}var xa=null;class ta{constructor(a,b){a||(xa=this);this.isReady=!1;this.options=b||{};(this.player=this.options.player)||H.setLanguage();"function"==typeof ta.__onApiConstructed&&ta.__onApiConstructed(this);
if(this.isCalledInCEF=sa.valid())this.isReady=this.isConnected=!0;this.callbackMap=new Map;this.websocket=null;this.callbackIndex=0;this.tickMarkerId="___tick_delegate_marker___";!this.player&&a&&(this.url=`ws://${a}`,this.connectWebSocket());this.apiQueue=new ob(c=>this.sendApi(c))}getPlayer(){return this.player}setHost(a,b){this.url=`ws://${a}:${b}`}connectWebSocket(){if(!this.player){this.log(`Connecting: ${this.url}`);if("undefined"==typeof window)this.websocket=new (require("ws"))(this.url);
...
b){return this.call({command:k.Reset,resetType:a||Da.ClearObjects},b)}saveProject(a){return this.call0(k.SaveProject,a)}registerTick(a,b,c){b=b||{};"__execute__"!=a&&(b.func="tick");this.call({command:k.RegisterJsCommunication,id:this.tickMarkerId,url:a,func:b.func,x:b.x||4,y:b.y||4,width:b.width||400,height:b.height||300,visible:b.visible||!1},c)}removeTick(a){this.call({command:k.UnRegisterJsCommunication,ids:[this.tickMarkerId]},a)}showTickWindow(a,b){this.isCalledInCEF?sa.showTickWindow(a):a?
this.registerTick("__show__",{},b):this.registerTick("",{},b)}executeJsInTickPage(a,b){this.registerTick("__execute__",{func:a},b)}getVersion(){return"6.1.0317.19681"}checkApiReady(){if(!this.isReady)throw console.error("The interface call is not ready!"),"The interface call is not ready!";return!0}setEnableAliases(){this.ct=this.cameraTour;this.tl=this.tileLayer;this.ctag=this.customTag;this.hdm2=this.hydrodynamicModel2;this.hdm=this.hydrodynamicModel;this.fe=this.finiteElement;this.line=this.polyline;
...
"./safari/safari_shim":14,"./utils":15}],3:[function(a,b,c){function e(f,m,v){m in f?Object.defineProperty(f,m,{value:v,enumerable:!0,configurable:!0,writable:!0}):f[m]=v;return f}function d(f){f.RTCPeerConnection.prototype.getLocalStreams=function(){var y=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};return Object.keys(this._shimmedLocalStreams).map(function(u){return y._shimmedLocalStreams[u][0]})};var m=f.RTCPeerConnection.prototype.addTrack;f.RTCPeerConnection.prototype.addTrack=
function(y,u){if(!u)return m.apply(this,arguments);this._shimmedLocalStreams=this._shimmedLocalStreams||{};var A=m.apply(this,arguments);this._shimmedLocalStreams[u.id]?-1===this._shimmedLocalStreams[u.id].indexOf(A)&&this._shimmedLocalStreams[u.id].push(A):this._shimmedLocalStreams[u.id]=[u,A];return A};var v=f.RTCPeerConnection.prototype.addStream;f.RTCPeerConnection.prototype.addStream=function(y){var u=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};y.getTracks().forEach(function(p){if(u.getSenders().find(function(w){return w.track===
p}))throw new DOMException("Track already exists.","InvalidAccessError");});var A=this.getSenders();v.apply(this,arguments);var n=this.getSenders().filter(function(p){return-1===A.indexOf(p)});this._shimmedLocalStreams[y.id]=[y].concat(n)};var x=f.RTCPeerConnection.prototype.removeStream;f.RTCPeerConnection.prototype.removeStream=function(y){this._shimmedLocalStreams=this._shimmedLocalStreams||{};delete this._shimmedLocalStreams[y.id];return x.apply(this,arguments)};var r=f.RTCPeerConnection.prototype.removeTrack;
f.RTCPeerConnection.prototype.removeTrack=function(y){var u=this;this._shimmedLocalStreams=this._shimmedLocalStreams||{};y&&Object.keys(this._shimmedLocalStreams).forEach(function(A){var n=u._shimmedLocalStreams[A].indexOf(y);-1!==n&&u._shimmedLocalStreams[A].splice(n,1);1===u._shimmedLocalStreams[A].length&&delete u._shimmedLocalStreams[A]});return r.apply(this,arguments)}}Object.defineProperty(c,"__esModule",{value:!0});c.shimGetDisplayMedia=c.shimGetUserMedia=void 0;var g="function"===typeof Symbol&&
...
c.shimOnTrack=function(f){if("object"!==("undefined"===typeof f?"undefined":g(f))||!f.RTCPeerConnection||"ontrack"in f.RTCPeerConnection.prototype)l.wrapPeerConnectionEvent(f,"track",function(v){v.transceiver||Object.defineProperty(v,"transceiver",{value:{receiver:v.receiver}});return v});else{Object.defineProperty(f.RTCPeerConnection.prototype,"ontrack",{get:function(){return this._ontrack},set:function(v){this._ontrack&&this.removeEventListener("track",this._ontrack);this.addEventListener("track",
this._ontrack=v)},enumerable:!0,configurable:!0});var m=f.RTCPeerConnection.prototype.setRemoteDescription;f.RTCPeerConnection.prototype.setRemoteDescription=function(){var v=this;this._ontrackpoly||(this._ontrackpoly=function(x){x.stream.addEventListener("addtrack",function(r){var y=void 0;y=f.RTCPeerConnection.prototype.getReceivers?v.getReceivers().find(function(A){return A.track&&A.track.id===r.track.id}):{track:r.track};var u=new Event("track");u.track=r.track;u.receiver=y;u.transceiver={receiver:y};
u.streams=[x.stream];v.dispatchEvent(u)});x.stream.getTracks().forEach(function(r){var y=void 0;y=f.RTCPeerConnection.prototype.getReceivers?v.getReceivers().find(function(A){return A.track&&A.track.id===r.id}):{track:r};var u=new Event("track");u.track=r;u.receiver=y;u.transceiver={receiver:y};u.streams=[x.stream];v.dispatchEvent(u)})},this.addEventListener("addstream",this._ontrackpoly));return m.apply(this,arguments)}}};c.shimGetSendersWithDtmf=function(f){if("object"===("undefined"===typeof f?
"undefined":g(f))&&f.RTCPeerConnection&&!("getSenders"in f.RTCPeerConnection.prototype)&&"createDTMFSender"in f.RTCPeerConnection.prototype){var m=function(A,n){return{track:n,get dtmf(){void 0===this._dtmf&&(this._dtmf="audio"===n.kind?A.createDTMFSender(n):null);return this._dtmf},_pc:A}};if(!f.RTCPeerConnection.prototype.getSenders){f.RTCPeerConnection.prototype.getSenders=function(){this._senders=this._senders||[];return this._senders.slice()};var v=f.RTCPeerConnection.prototype.addTrack;f.RTCPeerConnection.prototype.addTrack=
function(A,n){var p=v.apply(this,arguments);p||(p=m(this,A),this._senders.push(p));return p};var x=f.RTCPeerConnection.prototype.removeTrack;f.RTCPeerConnection.prototype.removeTrack=function(A){x.apply(this,arguments);var n=this._senders.indexOf(A);-1!==n&&this._senders.splice(n,1)}}var r=f.RTCPeerConnection.prototype.addStream;f.RTCPeerConnection.prototype.addStream=function(A){var n=this;this._senders=this._senders||[];r.apply(this,[A]);A.getTracks().forEach(function(p){n._senders.push(m(n,p))})};
...
f.RTCRtpSender.prototype)){var u=f.RTCPeerConnection.prototype.getSenders;f.RTCPeerConnection.prototype.getSenders=function(){var A=this,n=u.apply(this,[]);n.forEach(function(p){return p._pc=A});return n};Object.defineProperty(f.RTCRtpSender.prototype,"dtmf",{get:function(){void 0===this._dtmf&&(this._dtmf="audio"===this.track.kind?this._pc.createDTMFSender(this.track):null);return this._dtmf}})}};c.shimGetStats=function(f){if(f.RTCPeerConnection){var m=f.RTCPeerConnection.prototype.getStats;f.RTCPeerConnection.prototype.getStats=
function(){var v=this,x=Array.prototype.slice.call(arguments),r=x[0],y=x[1];x=x[2];if(0<arguments.length&&"function"===typeof r)return m.apply(this,arguments);if(0===m.length&&(0===arguments.length||"function"!==typeof r))return m.apply(this,[]);var u=function(n){var p={};n.result().forEach(function(w){var z={id:w.id,timestamp:w.timestamp,type:{localcandidate:"local-candidate",remotecandidate:"remote-candidate"}[w.type]||w.type};w.names().forEach(function(D){z[D]=w.stat(D)});p[z.id]=z});return p},
A=function(n){return new Map(Object.keys(n).map(function(p){return[p,n[p]]}))};return 2<=arguments.length?m.apply(this,[function(n){y(A(u(n)))},r]):(new Promise(function(n,p){m.apply(v,[function(w){n(A(u(w)))},p])})).then(y,x)}}};c.shimSenderReceiverGetStats=function(f){if("object"===("undefined"===typeof f?"undefined":g(f))&&f.RTCPeerConnection&&f.RTCRtpSender&&f.RTCRtpReceiver){if(!("getStats"in f.RTCRtpSender.prototype)){var m=f.RTCPeerConnection.prototype.getSenders;m&&(f.RTCPeerConnection.prototype.getSenders=
function(){var y=this,u=m.apply(this,[]);u.forEach(function(A){return A._pc=y});return u});var v=f.RTCPeerConnection.prototype.addTrack;v&&(f.RTCPeerConnection.prototype.addTrack=function(){var y=v.apply(this,arguments);y._pc=this;return y});f.RTCRtpSender.prototype.getStats=function(){var y=this;return this._pc.getStats().then(function(u){return l.filterStats(u,y.track,!0)})}}if(!("getStats"in f.RTCRtpReceiver.prototype)){var x=f.RTCPeerConnection.prototype.getReceivers;x&&(f.RTCPeerConnection.prototype.getReceivers=
function(){var y=this,u=x.apply(this,[]);u.forEach(function(A){return A._pc=y});return u});l.wrapPeerConnectionEvent(f,"track",function(y){y.receiver._pc=y.srcElement;return y});f.RTCRtpReceiver.prototype.getStats=function(){var y=this;return this._pc.getStats().then(function(u){return l.filterStats(u,y.track,!1)})}}if("getStats"in f.RTCRtpSender.prototype&&"getStats"in f.RTCRtpReceiver.prototype){var r=f.RTCPeerConnection.prototype.getStats;f.RTCPeerConnection.prototype.getStats=function(){if(0<
arguments.length&&arguments[0]instanceof f.MediaStreamTrack){var y=arguments[0],u=void 0,A=void 0,n=void 0;this.getSenders().forEach(function(p){p.track===y&&(u?n=!0:u=p)});this.getReceivers().forEach(function(p){p.track===y&&(A?n=!0:A=p);return p.track===y});return n||u&&A?Promise.reject(new DOMException("There are more than one sender or receiver for the track.","InvalidAccessError")):u?u.getStats():A?A.getStats():Promise.reject(new DOMException("There is no sender or receiver for the track.","InvalidAccessError"))}return r.apply(this,
arguments)}}}};c.shimAddTrackRemoveTrackWithNative=d;c.shimAddTrackRemoveTrack=function(f){function m(p,w){var z=w.sdp;Object.keys(p._reverseStreams||[]).forEach(function(D){D=p._reverseStreams[D];z=z.replace(new RegExp(p._streams[D.id].id,"g"),D.id)});return new RTCSessionDescription({type:w.type,sdp:z})}function v(p,w){var z=w.sdp;Object.keys(p._reverseStreams||[]).forEach(function(D){D=p._reverseStreams[D];z=z.replace(new RegExp(D.id,"g"),p._streams[D.id].id)});return new RTCSessionDescription({type:w.type,
...
{};this._reverseStreams=this._reverseStreams||{};p.getTracks().forEach(function(D){if(w.getSenders().find(function(E){return E.track===D}))throw new DOMException("Track already exists.","InvalidAccessError");});if(!this._reverseStreams[p.id]){var z=new f.MediaStream(p.getTracks());this._streams[p.id]=z;this._reverseStreams[z.id]=p;p=z}y.apply(this,[p])};var u=f.RTCPeerConnection.prototype.removeStream;f.RTCPeerConnection.prototype.removeStream=function(p){this._streams=this._streams||{};this._reverseStreams=
this._reverseStreams||{};u.apply(this,[this._streams[p.id]||p]);delete this._reverseStreams[this._streams[p.id]?this._streams[p.id].id:p.id];delete this._streams[p.id]};f.RTCPeerConnection.prototype.addTrack=function(p,w){var z=this;if("closed"===this.signalingState)throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.","InvalidStateError");var D=[].slice.call(arguments,1);if(1!==D.length||!D[0].getTracks().find(function(E){return E===p}))throw new DOMException("The adapter.js addTrack polyfill only supports a single  stream which is associated with the specified track.",
"NotSupportedError");if(this.getSenders().find(function(E){return E.track===p}))throw new DOMException("Track already exists.","InvalidAccessError");this._streams=this._streams||{};this._reverseStreams=this._reverseStreams||{};(D=this._streams[w.id])?(D.addTrack(p),Promise.resolve().then(function(){z.dispatchEvent(new Event("negotiationneeded"))})):(D=new f.MediaStream([p]),this._streams[w.id]=D,this._reverseStreams[D.id]=w,this.addStream(D));return this.getSenders().find(function(E){return E.track===
p})};["createOffer","createAnswer"].forEach(function(p){var w=f.RTCPeerConnection.prototype[p],z=e({},p,function(){var D=this,E=arguments;return arguments.length&&"function"===typeof arguments[0]?w.apply(this,[function(G){G=m(D,G);E[0].apply(null,[G])},function(G){E[1]&&E[1].apply(null,G)},arguments[2]]):w.apply(this,arguments).then(function(G){return m(D,G)})});f.RTCPeerConnection.prototype[p]=z[p]});var A=f.RTCPeerConnection.prototype.setLocalDescription;f.RTCPeerConnection.prototype.setLocalDescription=
function(){if(!arguments.length||!arguments[0].type)return A.apply(this,arguments);arguments[0]=v(this,arguments[0]);return A.apply(this,arguments)};var n=Object.getOwnPropertyDescriptor(f.RTCPeerConnection.prototype,"localDescription");Object.defineProperty(f.RTCPeerConnection.prototype,"localDescription",{get:function(){var p=n.get.apply(this);return""===p.type?p:m(this,p)}});f.RTCPeerConnection.prototype.removeTrack=function(p){var w=this;if("closed"===this.signalingState)throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.",
"InvalidStateError");if(!p._pc)throw new DOMException("Argument 1 of RTCPeerConnection.removeTrack does not implement interface RTCRtpSender.","TypeError");if(p._pc!==this)throw new DOMException("Sender was not created by this connection.","InvalidAccessError");this._streams=this._streams||{};var z=void 0;Object.keys(this._streams).forEach(function(D){w._streams[D].getTracks().find(function(E){return p.track===E})&&(z=w._streams[D])});z&&(1===z.getTracks().length?this.removeStream(this._reverseStreams[z.id]):
z.removeTrack(p.track),this.dispatchEvent(new Event("negotiationneeded")))}}};c.shimPeerConnection=function(f){var m=l.detectBrowser(f);!f.RTCPeerConnection&&f.webkitRTCPeerConnection&&(f.RTCPeerConnection=f.webkitRTCPeerConnection);if(f.RTCPeerConnection){var v=0===f.RTCPeerConnection.prototype.addIceCandidate.length;53>m.version&&["setLocalDescription","setRemoteDescription","addIceCandidate"].forEach(function(r){var y=f.RTCPeerConnection.prototype[r],u=e({},r,function(){arguments[0]=new ("addIceCandidate"===
...
"negotiationneeded",function(v){var x=v.target;if(!(72>m.version||x.getConfiguration&&"plan-b"===x.getConfiguration().sdpSemantics)||"stable"===x.signalingState)return v})};var l=function(f){if(f&&f.__esModule)return f;var m={};if(null!=f)for(var v in f)Object.prototype.hasOwnProperty.call(f,v)&&(m[v]=f[v]);m.default=f;return m}(a("../utils.js"))},{"../utils.js":15,"./getdisplaymedia":4,"./getusermedia":5}],4:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});c.shimGetDisplayMedia=
...
typeof r?"undefined":e(r))||r.mandatory||r.optional)return r;var y={};Object.keys(r).forEach(function(u){if("require"!==u&&"advanced"!==u&&"mediaSource"!==u){var A="object"===e(r[u])?r[u]:{ideal:r[u]};void 0!==A.exact&&"number"===typeof A.exact&&(A.min=A.max=A.exact);var n=function(w,z){return w?w+z.charAt(0).toUpperCase()+z.slice(1):"deviceId"===z?"sourceId":z};if(void 0!==A.ideal){y.optional=y.optional||[];var p={};"number"===typeof A.ideal?(p[n("min",u)]=A.ideal,y.optional.push(p),p={},p[n("max",
u)]=A.ideal):p[n("",u)]=A.ideal;y.optional.push(p)}void 0!==A.exact&&"number"!==typeof A.exact?(y.mandatory=y.mandatory||{},y.mandatory[n("",u)]=A.exact):["min","max"].forEach(function(w){void 0!==A[w]&&(y.mandatory=y.mandatory||{},y.mandatory[n(w,u)]=A[w])})}});r.advanced&&(y.optional=(y.optional||[]).concat(r.advanced));return y},m=function(r,y){if(61<=l.version)return y(r);if((r=JSON.parse(JSON.stringify(r)))&&"object"===e(r.audio)){var u=function(p,w,z){w in p&&!(z in p)&&(p[z]=p[w],delete p[w])};
r=JSON.parse(JSON.stringify(r));u(r.audio,"autoGainControl","googAutoGainControl");u(r.audio,"noiseSuppression","googNoiseSuppression");r.audio=f(r.audio)}if(r&&"object"===e(r.video)){var A=r.video.facingMode;A=A&&("object"===("undefined"===typeof A?"undefined":e(A))?A:{ideal:A});u=66>l.version;if(!(!A||"user"!==A.exact&&"environment"!==A.exact&&"user"!==A.ideal&&"environment"!==A.ideal||q.mediaDevices.getSupportedConstraints&&q.mediaDevices.getSupportedConstraints().facingMode&&!u)){delete r.video.facingMode;
var n=void 0;if("environment"===A.exact||"environment"===A.ideal)n=["back","rear"];else if("user"===A.exact||"user"===A.ideal)n=["front"];if(n)return q.mediaDevices.enumerateDevices().then(function(p){p=p.filter(function(z){return"videoinput"===z.kind});var w=p.find(function(z){return n.some(function(D){return z.label.toLowerCase().includes(D)})});!w&&p.length&&n.includes("back")&&(w=p[p.length-1]);w&&(r.video.deviceId=A.exact?{exact:w.deviceId}:{ideal:w.deviceId});r.video=f(r.video);g("chrome: "+
JSON.stringify(r));return y(r)})}r.video=f(r.video)}g("chrome: "+JSON.stringify(r));return y(r)},v=function(r){return 64<=l.version?r:{name:{PermissionDeniedError:"NotAllowedError",PermissionDismissedError:"NotAllowedError",InvalidStateError:"NotAllowedError",DevicesNotFoundError:"NotFoundError",ConstraintNotSatisfiedError:"OverconstrainedError",TrackStartError:"NotReadableError",MediaDeviceFailedDueToShutdown:"NotAllowedError",MediaDeviceKillSwitchOn:"NotAllowedError",TabCaptureError:"AbortError",
ScreenCaptureError:"AbortError",DeviceCaptureError:"AbortError"}[r.name]||r.name,message:r.message,constraint:r.constraint||r.constraintName,toString:function(){return this.name+(this.message&&": ")+this.message}}};q.getUserMedia=function(r,y,u){m(r,function(A){q.webkitGetUserMedia(A,y,function(n){u&&u(v(n))})})}.bind(q);if(q.mediaDevices.getUserMedia){var x=q.mediaDevices.getUserMedia.bind(q.mediaDevices);q.mediaDevices.getUserMedia=function(r){return m(r,function(y){return x(y).then(function(u){if(y.audio&&
!u.getAudioTracks().length||y.video&&!u.getVideoTracks().length)throw u.getTracks().forEach(function(A){A.stop()}),new DOMException("","NotFoundError");return u},function(u){return Promise.reject(v(u))})})}}}};var d=function(h){if(h&&h.__esModule)return h;var q={};if(null!=h)for(var l in h)Object.prototype.hasOwnProperty.call(h,l)&&(q[l]=h[l]);q.default=h;return q}(a("../utils.js")),g=d.log},{"../utils.js":15}],6:[function(a,b,c){Object.defineProperty(c,"__esModule",{value:!0});var e="function"===
...
if(null===r||2>r.length)return-1;r=parseInt(r[1],10);return r!==r?-1:r},m=function(r){var y=65536;"firefox"===q.browser&&(y=57>q.version?-1===r?16384:2147483637:60>q.version?57===q.version?65535:65536:2147483637);return y},v=function(r,y){var u=65536;"firefox"===q.browser&&57===q.version&&(u=65535);r=d.default.matchPrefix(r.sdp,"a=max-message-size:");0<r.length?u=parseInt(r[0].substr(19),10):"firefox"===q.browser&&-1!==y&&(u=2147483637);return u},x=h.RTCPeerConnection.prototype.setRemoteDescription;
...
{get:function(){return u}});this._sctp=y}return x.apply(this,arguments)}}};c.shimSendThrowTypeError=function(h){function q(f,m){var v=f.send;f.send=function(){var x=arguments[0];x=x.length||x.size||x.byteLength;if("open"===f.readyState&&m.sctp&&x>m.sctp.maxMessageSize)throw new TypeError("Message too large (can send a maximum of "+m.sctp.maxMessageSize+" bytes)");return v.apply(f,arguments)}}if(h.RTCPeerConnection&&"createDataChannel"in h.RTCPeerConnection.prototype){var l=h.RTCPeerConnection.prototype.createDataChannel;
...
q[l]=function(){this._connectionstatechangepoly||(this._connectionstatechangepoly=function(m){var v=m.target;if(v._lastConnectionState!==v.connectionState){v._lastConnectionState=v.connectionState;var x=new Event("connectionstatechange",m);v.dispatchEvent(x)}return m},this.addEventListener("iceconnectionstatechange",this._connectionstatechangepoly));return f.apply(this,arguments)}})}};c.removeAllowExtmapMixed=function(h){if(h.RTCPeerConnection){var q=g.detectBrowser(h);if(!("chrome"===q.browser&&
...
"dtmf",{get:function(){void 0===this._dtmf&&("audio"===this.track.kind?this._dtmf=new l.RTCDtmfSender(this):"video"===this.track.kind&&(this._dtmf=null));return this._dtmf}});l.RTCDtmfSender&&!l.RTCDTMFSender&&(l.RTCDTMFSender=l.RTCDtmfSender);var v=(0,q.default)(l,f.version);l.RTCPeerConnection=function(x){x&&x.iceServers&&(x.iceServers=(0,h.filterIceServers)(x.iceServers,f.version),g.log("ICE servers after filtering:",x.iceServers));return new v(x)};l.RTCPeerConnection.prototype=v.prototype};c.shimReplaceTrack=
...
("undefined"===typeof l?"undefined":d(l))&&(l.RTCPeerConnection||l.mozRTCPeerConnection)){!l.RTCPeerConnection&&l.mozRTCPeerConnection&&(l.RTCPeerConnection=l.mozRTCPeerConnection);53>f.version&&["setLocalDescription","setRemoteDescription","addIceCandidate"].forEach(function(r){var y=l.RTCPeerConnection.prototype[r],u=e({},r,function(){arguments[0]=new ("addIceCandidate"===r?l.RTCIceCandidate:l.RTCSessionDescription)(arguments[0]);return y.apply(this,arguments)});l.RTCPeerConnection.prototype[r]=
u[r]});if(68>f.version){var m=l.RTCPeerConnection.prototype.addIceCandidate;l.RTCPeerConnection.prototype.addIceCandidate=function(){return arguments[0]?arguments[0]&&""===arguments[0].candidate?Promise.resolve():m.apply(this,arguments):(arguments[1]&&arguments[1].apply(null),Promise.resolve())}}var v={inboundrtp:"inbound-rtp",outboundrtp:"outbound-rtp",candidatepair:"candidate-pair",localcandidate:"local-candidate",remotecandidate:"remote-candidate"},x=l.RTCPeerConnection.prototype.getStats;l.RTCPeerConnection.prototype.getStats=
function(){var r=Array.prototype.slice.call(arguments),y=r[1],u=r[2];return x.apply(this,[r[0]||null]).then(function(A){if(53>f.version&&!y)try{A.forEach(function(n){n.type=v[n.type]||n.type})}catch(n){if("TypeError"!==n.name)throw n;A.forEach(function(p,w){A.set(w,Object.assign({},p,{type:v[p.type]||p.type}))})}return A}).then(y,u)}}};c.shimSenderGetStats=function(l){if("object"===("undefined"===typeof l?"undefined":d(l))&&l.RTCPeerConnection&&l.RTCRtpSender&&!(l.RTCRtpSender&&"getStats"in l.RTCRtpSender.prototype)){var f=
l.RTCPeerConnection.prototype.getSenders;f&&(l.RTCPeerConnection.prototype.getSenders=function(){var v=this,x=f.apply(this,[]);x.forEach(function(r){return r._pc=v});return x});var m=l.RTCPeerConnection.prototype.addTrack;m&&(l.RTCPeerConnection.prototype.addTrack=function(){var v=m.apply(this,arguments);v._pc=this;return v});l.RTCRtpSender.prototype.getStats=function(){return this.track?this._pc.getStats(this.track):Promise.resolve(new Map)}}};c.shimReceiverGetStats=function(l){if("object"===("undefined"===
typeof l?"undefined":d(l))&&l.RTCPeerConnection&&l.RTCRtpSender&&!(l.RTCRtpSender&&"getStats"in l.RTCRtpReceiver.prototype)){var f=l.RTCPeerConnection.prototype.getReceivers;f&&(l.RTCPeerConnection.prototype.getReceivers=function(){var m=this,v=f.apply(this,[]);v.forEach(function(x){return x._pc=m});return v});q.wrapPeerConnectionEvent(l,"track",function(m){m.receiver._pc=m.srcElement;return m});l.RTCRtpReceiver.prototype.getStats=function(){return this._pc.getStats(this.track)}}};c.shimRemoveStream=
function(l){!l.RTCPeerConnection||"removeStream"in l.RTCPeerConnection.prototype||(l.RTCPeerConnection.prototype.removeStream=function(f){var m=this;q.deprecated("removeStream","removeTrack");this.getSenders().forEach(function(v){v.track&&f.getTracks().includes(v.track)&&m.removeTrack(v)})})};c.shimRTCDataChannel=function(l){l.DataChannel&&!l.RTCDataChannel&&(l.RTCDataChannel=l.DataChannel)};c.shimAddTransceiver=function(l){if("object"===("undefined"===typeof l?"undefined":d(l))&&l.RTCPeerConnection){var f=
l.RTCPeerConnection.prototype.addTransceiver;f&&(l.RTCPeerConnection.prototype.addTransceiver=function(){this.setParametersPromises=[];var m=arguments[1],v=m&&"sendEncodings"in m;v&&m.sendEncodings.forEach(function(y){if("rid"in y&&!/^[a-z0-9]{0,16}$/i.test(y.rid))throw new TypeError("Invalid RID value provided.");if("scaleResolutionDownBy"in y&&!(1<=parseFloat(y.scaleResolutionDownBy)))throw new RangeError("scale_resolution_down_by must be >= 1.0");if("maxFramerate"in y&&!(0<=parseFloat(y.maxFramerate)))throw new RangeError("max_framerate must be >= 0.0");
});var x=f.apply(this,arguments);if(v){var r=x.sender;v=r.getParameters();"encodings"in v||(v.encodings=m.sendEncodings,r.sendEncodings=m.sendEncodings,this.setParametersPromises.push(r.setParameters(v).then(function(){delete r.sendEncodings}).catch(function(){delete r.sendEncodings})))}return x})}};c.shimGetParameters=function(l){if("object"===("undefined"===typeof l?"undefined":d(l))&&l.RTCRtpSender){var f=l.RTCRtpSender.prototype.getParameters;f&&(l.RTCRtpSender.prototype.getParameters=function(){var m=
f.apply(this,arguments);return"sendEncodings"in this?Object.assign({},{encodings:this.sendEncodings},m):m})}};c.shimCreateOffer=function(l){if("object"===("undefined"===typeof l?"undefined":d(l))&&l.RTCPeerConnection){var f=l.RTCPeerConnection.prototype.createOffer;l.RTCPeerConnection.prototype.createOffer=function(){var m=this,v=arguments;return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(function(){return f.apply(m,v)}).finally(function(){m.setParametersPromises=
[]}):f.apply(this,arguments)}}};c.shimCreateAnswer=function(l){if("object"===("undefined"===typeof l?"undefined":d(l))&&l.RTCPeerConnection){var f=l.RTCPeerConnection.prototype.createAnswer;l.RTCPeerConnection.prototype.createAnswer=function(){var m=this,v=arguments;return this.setParametersPromises&&this.setParametersPromises.length?Promise.all(this.setParametersPromises).then(function(){return f.apply(m,v)}).finally(function(){m.setParametersPromises=[]}):f.apply(this,arguments)}}};var q=function(l){if(l&&
...
m=arguments.length,v=Array(1<m?m-1:0),x=1;x<m;x++)v[x-1]=arguments[x];v&&v.forEach(function(r){f._localStreams?f._localStreams.includes(r)||f._localStreams.push(r):f._localStreams=[r]});return q.apply(this,arguments)}}"removeStream"in h.RTCPeerConnection.prototype||(h.RTCPeerConnection.prototype.removeStream=function(l){var f=this;this._localStreams||(this._localStreams=[]);var m=this._localStreams.indexOf(l);if(-1!==m){this._localStreams.splice(m,1);var v=l.getTracks();this.getSenders().forEach(function(x){v.includes(x.track)&&
...
(this.removeEventListener("addstream",this._onaddstream),this.removeEventListener("track",this._onaddstreampoly));this.addEventListener("addstream",this._onaddstream=l);this.addEventListener("track",this._onaddstreampoly=function(m){m.streams.forEach(function(v){f._remoteStreams||(f._remoteStreams=[]);if(!f._remoteStreams.includes(v)){f._remoteStreams.push(v);var x=new Event("addstream");x.stream=v;f.dispatchEvent(x)}})})}});var q=h.RTCPeerConnection.prototype.setRemoteDescription;h.RTCPeerConnection.prototype.setRemoteDescription=
function(){var l=this;this._onaddstreampoly||this.addEventListener("track",this._onaddstreampoly=function(f){f.streams.forEach(function(m){l._remoteStreams||(l._remoteStreams=[]);if(!(0<=l._remoteStreams.indexOf(m))){l._remoteStreams.push(m);var v=new Event("addstream");v.stream=m;l.dispatchEvent(v)}})});return q.apply(l,arguments)}}};c.shimCallbacksAPI=function(h){if("object"===("undefined"===typeof h?"undefined":d(h))&&h.RTCPeerConnection){h=h.RTCPeerConnection.prototype;var q=h.createOffer,l=h.createAnswer,
f=h.setLocalDescription,m=h.setRemoteDescription,v=h.addIceCandidate;h.createOffer=function(r,y){var u=q.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(r,y);return Promise.resolve()};h.createAnswer=function(r,y){var u=l.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(r,y);return Promise.resolve()};var x=function(r,y,u){r=f.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};h.setLocalDescription=x;x=function(r,y,
u){r=m.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};h.setRemoteDescription=x;x=function(r,y,u){r=v.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};h.addIceCandidate=x}};c.shimGetUserMedia=function(h){var q=h&&h.navigator;if(q.mediaDevices&&q.mediaDevices.getUserMedia){h=q.mediaDevices;var l=h.getUserMedia.bind(h);q.mediaDevices.getUserMedia=function(f){return l(e(f))}}!q.getUserMedia&&q.mediaDevices&&q.mediaDevices.getUserMedia&&(q.getUserMedia=function(f,
m,v){q.mediaDevices.getUserMedia(f).then(m,v)}.bind(q))};c.shimConstraints=e;c.shimRTCIceServerUrls=function(h){var q=h.RTCPeerConnection;h.RTCPeerConnection=function(l,f){if(l&&l.iceServers){for(var m=[],v=0;v<l.iceServers.length;v++){var x=l.iceServers[v];!x.hasOwnProperty("urls")&&x.hasOwnProperty("url")?(g.deprecated("RTCIceServer.url","RTCIceServer.urls"),x=JSON.parse(JSON.stringify(x)),x.urls=x.url,delete x.url,m.push(x)):m.push(l.iceServers[v])}l.iceServers=m}return new q(l,f)};h.RTCPeerConnection.prototype=
...
arguments)}};c.shimAudioContext=function(h){"object"!==("undefined"===typeof h?"undefined":d(h))||h.AudioContext||(h.AudioContext=h.webkitAudioContext)};var g=function(h){if(h&&h.__esModule)return h;var q={};if(null!=h)for(var l in h)Object.prototype.hasOwnProperty.call(h,l)&&(q[l]=h[l]);q.default=h;return q}(a("../utils"))},{"../utils":15}],15:[function(a,b,c){function e(f,m,v){return(f=f.match(m))&&f.length>=v&&parseInt(f[v],10)}function d(f){return"[object Object]"!==Object.prototype.toString.call(f)?
f:Object.keys(f).reduce(function(m,v){var x="[object Object]"===Object.prototype.toString.call(f[v]),r=x?d(f[v]):f[v];x=x&&!Object.keys(r).length;if(void 0===r||x)return m;x=Object;var y=x.assign,u={};v in u?Object.defineProperty(u,v,{value:r,enumerable:!0,configurable:!0,writable:!0}):u[v]=r;return y.call(x,m,u)},{})}function g(f,m,v){m&&!v.has(m.id)&&(v.set(m.id,m),Object.keys(m).forEach(function(x){x.endsWith("Id")?g(f,f.get(m[x]),v):x.endsWith("Ids")&&m[x].forEach(function(r){g(f,f.get(r),v)})}))}
Object.defineProperty(c,"__esModule",{value:!0});var h="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(f){return typeof f}:function(f){return f&&"function"===typeof Symbol&&f.constructor===Symbol&&f!==Symbol.prototype?"symbol":typeof f};c.extractVersion=e;c.wrapPeerConnectionEvent=function(f,m,v){if(f.RTCPeerConnection){f=f.RTCPeerConnection.prototype;var x=f.addEventListener;f.addEventListener=function(y,u){if(y!==m)return x.apply(this,arguments);var A=function(n){(n=v(n))&&
(u.handleEvent?u.handleEvent(n):u(n))};this._eventMap=this._eventMap||{};this._eventMap[m]||(this._eventMap[m]=new Map);this._eventMap[m].set(u,A);return x.apply(this,[y,A])};var r=f.removeEventListener;f.removeEventListener=function(y,u){if(y!==m||!this._eventMap||!this._eventMap[m]||!this._eventMap[m].has(u))return r.apply(this,arguments);var A=this._eventMap[m].get(u);this._eventMap[m].delete(u);0===this._eventMap[m].size&&delete this._eventMap[m];0===Object.keys(this._eventMap).length&&delete this._eventMap;
...
f.navigator,v={browser:null,version:null};if("undefined"===typeof f||!f.navigator)return v.browser="Not a browser.",v;m.mozGetUserMedia?(v.browser="firefox",v.version=e(m.userAgent,/Firefox\/(\d+)\./,1)):m.webkitGetUserMedia||!1===f.isSecureContext&&f.webkitRTCPeerConnection&&!f.RTCIceGatherer?(v.browser="chrome",v.version=e(m.userAgent,/Chrom(e|ium)\/(\d+)\./,2)):m.mediaDevices&&m.userAgent.match(/Edge\/(\d+).(\d+)$/)?(v.browser="edge",v.version=e(m.userAgent,/Edge\/(\d+).(\d+)$/,2)):f.RTCPeerConnection&&
m.userAgent.match(/AppleWebKit\/(\d+)\./)?(v.browser="safari",v.version=e(m.userAgent,/AppleWebKit\/(\d+)\./,1),v.supportsUnifiedPlan=f.RTCRtpTransceiver&&"currentDirection"in f.RTCRtpTransceiver.prototype):v.browser="Not a supported browser.";return v};c.compactObject=d;c.walkStats=g;c.filterStats=function(f,m,v){var x=v?"outbound-rtp":"inbound-rtp",r=new Map;if(null===m)return r;var y=[];f.forEach(function(u){"track"===u.type&&u.trackIdentifier===m.id&&y.push(u)});y.forEach(function(u){f.forEach(function(A){A.type===
x&&A.trackId===u.id&&g(f,A,r)})});return r};var q=!0,l=!0},{}],16:[function(a,b,c){function e(m,v,x,r,y){v=f.writeRtpDescription(m.kind,v);v+=f.writeIceParameters(m.iceGatherer.getLocalParameters());v+=f.writeDtlsParameters(m.dtlsTransport.getLocalParameters(),"offer"===x?"actpass":y||"active");v+="a=mid:"+m.mid+"\r\n";v=m.rtpSender&&m.rtpReceiver?v+"a=sendrecv\r\n":m.rtpSender?v+"a=sendonly\r\n":m.rtpReceiver?v+"a=recvonly\r\n":v+"a=inactive\r\n";m.rtpSender&&(x=m.rtpSender._initialTrackId||m.rtpSender.track.id,
m.rtpSender._initialTrackId=x,r="msid:"+(r?r.id:"-")+" "+x+"\r\n",v=v+("a="+r)+("a=ssrc:"+m.sendEncodingParameters[0].ssrc+" "+r),m.sendEncodingParameters[0].rtx&&(v+="a=ssrc:"+m.sendEncodingParameters[0].rtx.ssrc+" "+r,v+="a=ssrc-group:FID "+m.sendEncodingParameters[0].ssrc+" "+m.sendEncodingParameters[0].rtx.ssrc+"\r\n"));v+="a=ssrc:"+m.sendEncodingParameters[0].ssrc+" cname:"+f.localCName+"\r\n";m.rtpSender&&m.sendEncodingParameters[0].rtx&&(v+="a=ssrc:"+m.sendEncodingParameters[0].rtx.ssrc+" cname:"+
f.localCName+"\r\n");return v}function d(m,v){var x=!1;m=JSON.parse(JSON.stringify(m));return m.filter(function(r){if(r&&(r.urls||r.url)){var y=r.urls||r.url;r.url&&!r.urls&&console.warn("RTCIceServer.url is deprecated! Use urls instead.");var u="string"===typeof y;u&&(y=[y]);y=y.filter(function(A){return 0!==A.indexOf("turn:")||-1===A.indexOf("transport=udp")||-1!==A.indexOf("turn:[")||x?0===A.indexOf("stun:")&&14393<=v&&-1===A.indexOf("?transport=udp"):x=!0});delete r.url;r.urls=u?y[0]:y;return!!y.length}})}
function g(m,v){var x={codecs:[],headerExtensions:[],fecMechanisms:[]},r=function(u,A){u=parseInt(u,10);for(var n=0;n<A.length;n++)if(A[n].payloadType===u||A[n].preferredPayloadType===u)return A[n]},y=function(u,A,n,p){u=r(u.parameters.apt,n);A=r(A.parameters.apt,p);return u&&A&&u.name.toLowerCase()===A.name.toLowerCase()};m.codecs.forEach(function(u){for(var A=0;A<v.codecs.length;A++){var n=v.codecs[A];if(u.name.toLowerCase()===n.name.toLowerCase()&&u.clockRate===n.clockRate&&("rtx"!==u.name.toLowerCase()||
!u.parameters||!n.parameters.apt||y(u,n,m.codecs,v.codecs))){n=JSON.parse(JSON.stringify(n));n.numChannels=Math.min(u.numChannels,n.numChannels);x.codecs.push(n);n.rtcpFeedback=n.rtcpFeedback.filter(function(p){for(var w=0;w<u.rtcpFeedback.length;w++)if(u.rtcpFeedback[w].type===p.type&&u.rtcpFeedback[w].parameter===p.parameter)return!0;return!1});break}}});m.headerExtensions.forEach(function(u){for(var A=0;A<v.headerExtensions.length;A++){var n=v.headerExtensions[A];if(u.uri===n.uri){x.headerExtensions.push(n);
break}}});return x}function h(m,v,x){return-1!=={offer:{setLocalDescription:["stable","have-local-offer"],setRemoteDescription:["stable","have-remote-offer"]},answer:{setLocalDescription:["have-remote-offer","have-local-pranswer"],setRemoteDescription:["have-local-offer","have-remote-pranswer"]}}[v][m].indexOf(x)}function q(m,v){var x=m.getRemoteCandidates().find(function(r){return v.foundation===r.foundation&&v.ip===r.ip&&v.port===r.port&&v.priority===r.priority&&v.protocol===r.protocol&&v.type===
r.type});x||m.addRemoteCandidate(v);return!x}function l(m,v){v=Error(v);v.name=m;v.code={NotSupportedError:9,InvalidStateError:11,InvalidAccessError:15,TypeError:void 0,OperationError:void 0}[m];return v}var f=a("sdp");b.exports=function(m,v){function x(n,p){p.addTrack(n);p.dispatchEvent(new m.MediaStreamTrackEvent("addtrack",{track:n}))}function r(n,p){p.removeTrack(n);p.dispatchEvent(new m.MediaStreamTrackEvent("removetrack",{track:n}))}function y(n,p,w,z){var D=new Event("track");D.track=p;D.receiver=
w;D.transceiver={receiver:w};D.streams=z;m.setTimeout(function(){n._dispatchEvent("track",D)})}var u=function(n){var p=this,w=document.createDocumentFragment();["addEventListener","removeEventListener","dispatchEvent"].forEach(function(D){p[D]=w[D].bind(w)});this.canTrickleIceCandidates=null;this.needNegotiation=!1;this.localStreams=[];this.remoteStreams=[];this._remoteDescription=this._localDescription=null;this.signalingState="stable";this.iceGatheringState=this.connectionState=this.iceConnectionState=
"new";n=JSON.parse(JSON.stringify(n||{}));this.usingBundle="max-bundle"===n.bundlePolicy;if("negotiate"===n.rtcpMuxPolicy)throw l("NotSupportedError","rtcpMuxPolicy 'negotiate' is not supported");n.rtcpMuxPolicy||(n.rtcpMuxPolicy="require");switch(n.iceTransportPolicy){case "all":case "relay":break;default:n.iceTransportPolicy="all"}switch(n.bundlePolicy){case "balanced":case "max-compat":case "max-bundle":break;default:n.bundlePolicy="balanced"}n.iceServers=d(n.iceServers||[],v);this._iceGatherers=
...
"remoteDescription",{configurable:!0,get:function(){return this._remoteDescription}});u.prototype.onicecandidate=null;u.prototype.onaddstream=null;u.prototype.ontrack=null;u.prototype.onremovestream=null;u.prototype.onsignalingstatechange=null;u.prototype.oniceconnectionstatechange=null;u.prototype.onconnectionstatechange=null;u.prototype.onicegatheringstatechange=null;u.prototype.onnegotiationneeded=null;u.prototype.ondatachannel=null;u.prototype._dispatchEvent=function(n,p){if(!this._isClosed&&
(this.dispatchEvent(p),"function"===typeof this["on"+n]))this["on"+n](p)};u.prototype._emitGatheringStateChange=function(){var n=new Event("icegatheringstatechange");this._dispatchEvent("icegatheringstatechange",n)};u.prototype.getConfiguration=function(){return this._config};u.prototype.getLocalStreams=function(){return this.localStreams};u.prototype.getRemoteStreams=function(){return this.remoteStreams};u.prototype._createTransceiver=function(n,p){var w=0<this.transceivers.length;n={track:null,
...
return n};u.prototype.addTrack=function(n,p){if(this._isClosed)throw l("InvalidStateError","Attempted to call addTrack on a closed peerconnection.");if(this.transceivers.find(function(D){return D.track===n}))throw l("InvalidAccessError","Track already exists.");for(var w,z=0;z<this.transceivers.length;z++)this.transceivers[z].track||this.transceivers[z].kind!==n.kind||(w=this.transceivers[z]);w||(w=this._createTransceiver(n.kind));this._maybeFireNegotiationNeeded();-1===this.localStreams.indexOf(p)&&
this.localStreams.push(p);w.track=n;w.stream=p;w.rtpSender=new m.RTCRtpSender(n,w.dtlsTransport);return w.rtpSender};u.prototype.addStream=function(n){var p=this;if(15025<=v)n.getTracks().forEach(function(z){p.addTrack(z,n)});else{var w=n.clone();n.getTracks().forEach(function(z,D){var E=w.getTracks()[D];z.addEventListener("enabled",function(G){E.enabled=G.enabled})});w.getTracks().forEach(function(z){p.addTrack(z,w)})}};u.prototype.removeTrack=function(n){if(this._isClosed)throw l("InvalidStateError",
...
this.localStreams.indexOf(w)&&this.localStreams.splice(this.localStreams.indexOf(w),1);this._maybeFireNegotiationNeeded()};u.prototype.removeStream=function(n){var p=this;n.getTracks().forEach(function(w){var z=p.getSenders().find(function(D){return D.track===w});z&&p.removeTrack(z)})};u.prototype.getSenders=function(){return this.transceivers.filter(function(n){return!!n.rtpSender}).map(function(n){return n.rtpSender})};u.prototype.getReceivers=function(){return this.transceivers.filter(function(n){return!!n.rtpReceiver}).map(function(n){return n.rtpReceiver})};
u.prototype._createIceGatherer=function(n,p){var w=this;if(p&&0<n)return this.transceivers[0].iceGatherer;if(this._iceGatherers.length)return this._iceGatherers.shift();var z=new m.RTCIceGatherer({iceServers:this._config.iceServers,gatherPolicy:this._config.iceTransportPolicy});Object.defineProperty(z,"state",{value:"new",writable:!0});this.transceivers[n].bufferedCandidateEvents=[];this.transceivers[n].bufferCandidates=function(D){var E=!D.candidate||0===Object.keys(D.candidate).length;z.state=E?
"completed":"gathering";null!==w.transceivers[n].bufferedCandidateEvents&&w.transceivers[n].bufferedCandidateEvents.push(D)};z.addEventListener("localcandidate",this.transceivers[n].bufferCandidates);return z};u.prototype._gather=function(n,p){var w=this,z=this.transceivers[p].iceGatherer;if(!z.onlocalcandidate){var D=this.transceivers[p].bufferedCandidateEvents;this.transceivers[p].bufferedCandidateEvents=null;z.removeEventListener("localcandidate",this.transceivers[p].bufferCandidates);z.onlocalcandidate=
...
(w.iceGatheringState="gathering",w._emitGatheringStateChange());E||w._dispatchEvent("icecandidate",G);N&&(w._dispatchEvent("icecandidate",new Event("icecandidate")),w.iceGatheringState="complete",w._emitGatheringStateChange())}};m.setTimeout(function(){D.forEach(function(E){z.onlocalcandidate(E)})},0)}};u.prototype._createIceAndDtlsTransports=function(){var n=this,p=new m.RTCIceTransport(null);p.onicestatechange=function(){n._updateIceConnectionState();n._updateConnectionState()};var w=new m.RTCDtlsTransport(p);
...
delete p.onerror,delete this.transceivers[n].dtlsTransport};u.prototype._transceive=function(n,p,w){var z=g(n.localCapabilities,n.remoteCapabilities);p&&n.rtpSender&&(z.encodings=n.sendEncodingParameters,z.rtcp={cname:f.localCName,compound:n.rtcpParameters.compound},n.recvEncodingParameters.length&&(z.rtcp.ssrc=n.recvEncodingParameters[0].ssrc),n.rtpSender.send(z));w&&n.rtpReceiver&&0<z.codecs.length&&("video"===n.kind&&n.recvEncodingParameters&&15019>v&&n.recvEncodingParameters.forEach(function(D){delete D.rtx}),
z.encodings=n.recvEncodingParameters.length?n.recvEncodingParameters:[{}],z.rtcp={compound:n.rtcpParameters.compound},n.rtcpParameters.cname&&(z.rtcp.cname=n.rtcpParameters.cname),n.sendEncodingParameters.length&&(z.rtcp.ssrc=n.sendEncodingParameters[0].ssrc),n.rtpReceiver.receive(z))};u.prototype.setLocalDescription=function(n){var p=this;if(-1===["offer","answer"].indexOf(n.type))return Promise.reject(l("TypeError",'Unsupported type "'+n.type+'"'));if(!h("setLocalDescription",n.type,p.signalingState)||
p._isClosed)return Promise.reject(l("InvalidStateError","Can not set local "+n.type+" in state "+p.signalingState));if("offer"===n.type){var w=f.splitSections(n.sdp);var z=w.shift();w.forEach(function(E,G){E=f.parseRtpParameters(E);p.transceivers[G].localCapabilities=E});p.transceivers.forEach(function(E,G){p._gather(E.mid,G)})}else if("answer"===n.type){w=f.splitSections(p._remoteDescription.sdp);z=w.shift();var D=0<f.matchPrefix(z,"a=ice-lite").length;w.forEach(function(E,G){var N=p.transceivers[G],
Z=N.iceGatherer,L=N.iceTransport,K=N.dtlsTransport,Q=N.localCapabilities,T=N.remoteCapabilities;if(!(f.isRejected(E)&&0===f.matchPrefix(E,"a=bundle-only").length||N.rejected)){var aa=f.getIceParameters(E,z);E=f.getDtlsParameters(E,z);D&&(E.role="server");p.usingBundle&&0!==G||(p._gather(N.mid,G),"new"===L.state&&L.start(Z,aa,D?"controlling":"controlled"),"new"===K.state&&K.start(E));G=g(Q,T);p._transceive(N,0<G.codecs.length,!1)}})}p._localDescription={type:n.type,sdp:n.sdp};"offer"===n.type?p._updateSignalingState("have-local-offer"):
p._updateSignalingState("stable");return Promise.resolve()};u.prototype.setRemoteDescription=function(n){var p=this;if(-1===["offer","answer"].indexOf(n.type))return Promise.reject(l("TypeError",'Unsupported type "'+n.type+'"'));if(!h("setRemoteDescription",n.type,p.signalingState)||p._isClosed)return Promise.reject(l("InvalidStateError","Can not set remote "+n.type+" in state "+p.signalingState));var w={};p.remoteStreams.forEach(function(L){w[L.id]=L});var z=[],D=f.splitSections(n.sdp),E=D.shift(),
G=0<f.matchPrefix(E,"a=ice-lite").length,N=0<f.matchPrefix(E,"a=group:BUNDLE ").length;p.usingBundle=N;var Z=f.matchPrefix(E,"a=ice-options:")[0];p.canTrickleIceCandidates=Z?0<=Z.substr(14).split(" ").indexOf("trickle"):!1;D.forEach(function(L,K){var Q=f.splitLines(L),T=f.getKind(L),aa=f.isRejected(L)&&0===f.matchPrefix(L,"a=bundle-only").length,ma=Q[0].substr(2).split(" ")[2];Q=f.getDirection(L,E);var X=f.parseMsid(L),oa=f.getMid(L)||f.generateIdentifier();if(aa||"application"===T&&("DTLS/SCTP"===
ma||"UDP/DTLS/SCTP"===ma))p.transceivers[K]={mid:oa,kind:T,protocol:ma,rejected:!0};else{!aa&&p.transceivers[K]&&p.transceivers[K].rejected&&(p.transceivers[K]=p._createTransceiver(T,!0));var Ga=f.parseRtpParameters(L);if(!aa){var pa=f.getIceParameters(L,E);var Ha=f.getDtlsParameters(L,E);Ha.role="client"}ma=f.parseRtpEncodingParameters(L);var Ia=f.parseRtcpParameters(L),Ja=0<f.matchPrefix(L,"a=end-of-candidates",E).length,na=f.matchPrefix(L,"a=candidate:").map(function(Y){return f.parseCandidate(Y)}).filter(function(Y){return 1===
Y.component});("offer"===n.type||"answer"===n.type)&&!aa&&N&&0<K&&p.transceivers[K]&&(p._disposeIceAndDtlsTransports(K),p.transceivers[K].iceGatherer=p.transceivers[0].iceGatherer,p.transceivers[K].iceTransport=p.transceivers[0].iceTransport,p.transceivers[K].dtlsTransport=p.transceivers[0].dtlsTransport,p.transceivers[K].rtpSender&&p.transceivers[K].rtpSender.setTransport(p.transceivers[0].dtlsTransport),p.transceivers[K].rtpReceiver&&p.transceivers[K].rtpReceiver.setTransport(p.transceivers[0].dtlsTransport));
if("offer"!==n.type||aa)"answer"!==n.type||aa||(P=p.transceivers[K],ka=P.iceGatherer,T=P.iceTransport,oa=P.dtlsTransport,ha=P.rtpReceiver,aa=P.sendEncodingParameters,L=P.localCapabilities,p.transceivers[K].recvEncodingParameters=ma,p.transceivers[K].remoteCapabilities=Ga,p.transceivers[K].rtcpParameters=Ia,na.length&&"new"===T.state&&(!G&&!Ja||N&&0!==K?na.forEach(function(Y){q(P.iceTransport,Y)}):T.setRemoteCandidates(na)),N&&0!==K||("new"===T.state&&T.start(ka,pa,"controlling"),"new"===oa.state&&
oa.start(Ha)),!g(P.localCapabilities,P.remoteCapabilities).codecs.filter(function(Y){return"rtx"===Y.name.toLowerCase()}).length&&P.sendEncodingParameters[0].rtx&&delete P.sendEncodingParameters[0].rtx,p._transceive(P,"sendrecv"===Q||"recvonly"===Q,"sendrecv"===Q||"sendonly"===Q),!ha||"sendrecv"!==Q&&"sendonly"!==Q?delete P.rtpReceiver:(Q=ha.track,X?(w[X.stream]||(w[X.stream]=new m.MediaStream),x(Q,w[X.stream]),z.push([Q,ha,w[X.stream]])):(w.default||(w.default=new m.MediaStream),x(Q,w.default),z.push([Q,
ha,w.default]))));else{var P=p.transceivers[K]||p._createTransceiver(T);P.mid=oa;P.iceGatherer||(P.iceGatherer=p._createIceGatherer(K,N));na.length&&"new"===P.iceTransport.state&&(!Ja||N&&0!==K?na.forEach(function(Y){q(P.iceTransport,Y)}):P.iceTransport.setRemoteCandidates(na));L=m.RTCRtpReceiver.getCapabilities(T);15019>v&&(L.codecs=L.codecs.filter(function(Y){return"rtx"!==Y.name}));aa=P.sendEncodingParameters||[{ssrc:1001*(2*K+2)}];pa=!1;if("sendrecv"===Q||"sendonly"===Q){pa=!P.rtpReceiver;var ha=
P.rtpReceiver||new m.RTCRtpReceiver(P.dtlsTransport,T);if(pa){Q=ha.track;if(!X||"-"!==X.stream)if(X){w[X.stream]||(w[X.stream]=new m.MediaStream,Object.defineProperty(w[X.stream],"id",{get:function(){return X.stream}}));Object.defineProperty(Q,"id",{get:function(){return X.track}});var ka=w[X.stream]}else w.default||(w.default=new m.MediaStream),ka=w.default;ka&&(x(Q,ka),P.associatedRemoteMediaStreams.push(ka));z.push([Q,ha,ka])}}else P.rtpReceiver&&P.rtpReceiver.track&&(P.associatedRemoteMediaStreams.forEach(function(Y){var Ka=
Y.getTracks().find(function(rc){return rc.id===P.rtpReceiver.track.id});Ka&&r(Ka,Y)}),P.associatedRemoteMediaStreams=[]);P.localCapabilities=L;P.remoteCapabilities=Ga;P.rtpReceiver=ha;P.rtcpParameters=Ia;P.sendEncodingParameters=aa;P.recvEncodingParameters=ma;p._transceive(p.transceivers[K],!1,pa)}}});void 0===p._dtlsRole&&(p._dtlsRole="offer"===n.type?"active":"passive");p._remoteDescription={type:n.type,sdp:n.sdp};"offer"===n.type?p._updateSignalingState("have-remote-offer"):p._updateSignalingState("stable");
Object.keys(w).forEach(function(L){var K=w[L];if(K.getTracks().length){if(-1===p.remoteStreams.indexOf(K)){p.remoteStreams.push(K);var Q=new Event("addstream");Q.stream=K;m.setTimeout(function(){p._dispatchEvent("addstream",Q)})}z.forEach(function(T){K.id===T[2].id&&y(p,T[0],T[1],[K])})}});z.forEach(function(L){L[2]||y(p,L[0],L[1],[])});m.setTimeout(function(){p&&p.transceivers&&p.transceivers.forEach(function(L){L.iceTransport&&"new"===L.iceTransport.state&&0<L.iceTransport.getRemoteCandidates().length&&
(console.warn("Timeout for addRemoteCandidate. Consider sending an end-of-candidates notification"),L.iceTransport.addRemoteCandidate({}))})},4E3);return Promise.resolve()};u.prototype.close=function(){this.transceivers.forEach(function(n){n.iceTransport&&n.iceTransport.stop();n.dtlsTransport&&n.dtlsTransport.stop();n.rtpSender&&n.rtpSender.stop();n.rtpReceiver&&n.rtpReceiver.stop()});this._isClosed=!0;this._updateSignalingState("closed")};u.prototype._updateSignalingState=function(n){this.signalingState=
n;n=new Event("signalingstatechange");this._dispatchEvent("signalingstatechange",n)};u.prototype._maybeFireNegotiationNeeded=function(){var n=this;"stable"===this.signalingState&&!0!==this.needNegotiation&&(this.needNegotiation=!0,m.setTimeout(function(){if(n.needNegotiation){n.needNegotiation=!1;var p=new Event("negotiationneeded");n._dispatchEvent("negotiationneeded",p)}},0))};u.prototype._updateIceConnectionState=function(){var n={"new":0,closed:0,checking:0,connected:0,completed:0,disconnected:0,
...
(z=!0===n.offerToReceiveVideo?1:!1===n.offerToReceiveVideo?0:n.offerToReceiveVideo)}for(p.transceivers.forEach(function(E){"audio"===E.kind?(w--,0>w&&(E.wantReceive=!1)):"video"===E.kind&&(z--,0>z&&(E.wantReceive=!1))});0<w||0<z;)0<w&&(p._createTransceiver("audio"),w--),0<z&&(p._createTransceiver("video"),z--);var D=f.writeSessionBoilerplate(p._sdpSessionId,p._sdpSessionVersion++);p.transceivers.forEach(function(E,G){var N=E.track,Z=E.kind,L=E.mid||f.generateIdentifier();E.mid=L;E.iceGatherer||(E.iceGatherer=
p._createIceGatherer(G,p.usingBundle));L=m.RTCRtpSender.getCapabilities(Z);15019>v&&(L.codecs=L.codecs.filter(function(K){return"rtx"!==K.name}));L.codecs.forEach(function(K){"H264"===K.name&&void 0===K.parameters["level-asymmetry-allowed"]&&(K.parameters["level-asymmetry-allowed"]="1");E.remoteCapabilities&&E.remoteCapabilities.codecs&&E.remoteCapabilities.codecs.forEach(function(Q){K.name.toLowerCase()===Q.name.toLowerCase()&&K.clockRate===Q.clockRate&&(K.preferredPayloadType=Q.payloadType)})});
L.headerExtensions.forEach(function(K){(E.remoteCapabilities&&E.remoteCapabilities.headerExtensions||[]).forEach(function(Q){K.uri===Q.uri&&(K.id=Q.id)})});G=E.sendEncodingParameters||[{ssrc:1001*(2*G+1)}];N&&15019<=v&&"video"===Z&&!G[0].rtx&&(G[0].rtx={ssrc:G[0].ssrc+1});E.wantReceive&&(E.rtpReceiver=new m.RTCRtpReceiver(E.dtlsTransport,Z));E.localCapabilities=L;E.sendEncodingParameters=G});"max-compat"!==p._config.bundlePolicy&&(D+="a=group:BUNDLE "+p.transceivers.map(function(E){return E.mid}).join(" ")+
"\r\n");D+="a=ice-options:trickle\r\n";p.transceivers.forEach(function(E,G){D+=e(E,E.localCapabilities,"offer",E.stream,p._dtlsRole);D+="a=rtcp-rsize\r\n";!E.iceGatherer||"new"===p.iceGatheringState||0!==G&&p.usingBundle||(E.iceGatherer.getLocalCandidates().forEach(function(N){N.component=1;D+="a="+f.writeCandidate(N)+"\r\n"}),"completed"===E.iceGatherer.state&&(D+="a=end-of-candidates\r\n"))});n=new m.RTCSessionDescription({type:"offer",sdp:D});return Promise.resolve(n)};u.prototype.createAnswer=
function(){var n=this;if(n._isClosed)return Promise.reject(l("InvalidStateError","Can not call createAnswer after close"));if("have-remote-offer"!==n.signalingState&&"have-local-pranswer"!==n.signalingState)return Promise.reject(l("InvalidStateError","Can not call createAnswer in signalingState "+n.signalingState));var p=f.writeSessionBoilerplate(n._sdpSessionId,n._sdpSessionVersion++);n.usingBundle&&(p+="a=group:BUNDLE "+n.transceivers.map(function(D){return D.mid}).join(" ")+"\r\n");p+="a=ice-options:trickle\r\n";
var w=f.getMediaSections(n._remoteDescription.sdp).length;n.transceivers.forEach(function(D,E){if(!(E+1>w))if(D.rejected)"application"===D.kind?p="DTLS/SCTP"===D.protocol?p+"m=application 0 DTLS/SCTP 5000\r\n":p+("m=application 0 "+D.protocol+" webrtc-datachannel\r\n"):"audio"===D.kind?p+="m=audio 0 UDP/TLS/RTP/SAVPF 0\r\na=rtpmap:0 PCMU/8000\r\n":"video"===D.kind&&(p+="m=video 0 UDP/TLS/RTP/SAVPF 120\r\na=rtpmap:120 VP8/90000\r\n"),p+="c=IN IP4 0.0.0.0\r\na=inactive\r\na=mid:"+D.mid+"\r\n";else{if(D.stream){var G;
"audio"===D.kind?G=D.stream.getAudioTracks()[0]:"video"===D.kind&&(G=D.stream.getVideoTracks()[0]);G&&15019<=v&&"video"===D.kind&&!D.sendEncodingParameters[0].rtx&&(D.sendEncodingParameters[0].rtx={ssrc:D.sendEncodingParameters[0].ssrc+1})}E=g(D.localCapabilities,D.remoteCapabilities);!E.codecs.filter(function(N){return"rtx"===N.name.toLowerCase()}).length&&D.sendEncodingParameters[0].rtx&&delete D.sendEncodingParameters[0].rtx;p+=e(D,E,"answer",D.stream,n._dtlsRole);D.rtcpParameters&&D.rtcpParameters.reducedSize&&
(p+="a=rtcp-rsize\r\n")}});var z=new m.RTCSessionDescription({type:"answer",sdp:p});return Promise.resolve(z)};u.prototype.addIceCandidate=function(n){var p=this,w;return n&&void 0===n.sdpMLineIndex&&!n.sdpMid?Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")):new Promise(function(z,D){if(p._remoteDescription)if(n&&""!==n.candidate){var E=n.sdpMLineIndex;if(n.sdpMid)for(var G=0;G<p.transceivers.length;G++)if(p.transceivers[G].mid===n.sdpMid){E=G;break}var N=p.transceivers[E];if(N){if(N.rejected)return z();
G=0<Object.keys(n.candidate).length?f.parseCandidate(n.candidate):{};if("tcp"===G.protocol&&(0===G.port||9===G.port)||G.component&&1!==G.component)return z();if((0===E||0<E&&N.iceTransport!==p.transceivers[0].iceTransport)&&!q(N.iceTransport,G))return D(l("OperationError","Can not add ICE candidate"));D=n.candidate.trim();0===D.indexOf("a=")&&(D=D.substr(2));w=f.getMediaSections(p._remoteDescription.sdp);w[E]+="a="+(G.type?D:"end-of-candidates")+"\r\n";p._remoteDescription.sdp=f.getDescription(p._remoteDescription.sdp)+
w.join("")}else return D(l("OperationError","Can not add ICE candidate"))}else for(E=0;E<p.transceivers.length&&(p.transceivers[E].rejected||(p.transceivers[E].iceTransport.addRemoteCandidate({}),w=f.getMediaSections(p._remoteDescription.sdp),w[E]+="a=end-of-candidates\r\n",p._remoteDescription.sdp=f.getDescription(p._remoteDescription.sdp)+w.join(""),!p.usingBundle));E++);else return D(l("InvalidStateError","Can not add ICE candidate without a remote description"));z()})};u.prototype.getStats=function(n){if(n&&
n instanceof m.MediaStreamTrack){var p=null;this.transceivers.forEach(function(z){z.rtpSender&&z.rtpSender.track===n?p=z.rtpSender:z.rtpReceiver&&z.rtpReceiver.track===n&&(p=z.rtpReceiver)});if(!p)throw l("InvalidAccessError","Invalid selector.");return p.getStats()}var w=[];this.transceivers.forEach(function(z){["rtpSender","rtpReceiver","iceGatherer","iceTransport","dtlsTransport"].forEach(function(D){z[D]&&w.push(z[D].getStats())})});return Promise.all(w).then(function(z){var D=new Map;z.forEach(function(E){E.forEach(function(G){D.set(G.id,
G)})});return D})};["RTCRtpSender","RTCRtpReceiver","RTCIceGatherer","RTCIceTransport","RTCDtlsTransport"].forEach(function(n){if((n=m[n])&&n.prototype&&n.prototype.getStats){var p=n.prototype.getStats;n.prototype.getStats=function(){return p.apply(this).then(function(w){var z=new Map;Object.keys(w).forEach(function(D){var E=w[D];w[D].type={inboundrtp:"inbound-rtp",outboundrtp:"outbound-rtp",candidatepair:"candidate-pair",localcandidate:"local-candidate",remotecandidate:"remote-candidate"}[E.type]||
E.type;z.set(D,w[D])});return z})}}});var A=["createOffer","createAnswer"];A.forEach(function(n){var p=u.prototype[n];u.prototype[n]=function(){var w=arguments;return"function"===typeof w[0]||"function"===typeof w[1]?p.apply(this,[arguments[2]]).then(function(z){"function"===typeof w[0]&&w[0].apply(null,[z])},function(z){"function"===typeof w[1]&&w[1].apply(null,[z])}):p.apply(this,arguments)}});A=["setLocalDescription","setRemoteDescription","addIceCandidate"];A.forEach(function(n){var p=u.prototype[n];
u.prototype[n]=function(){var w=arguments;return"function"===typeof w[1]||"function"===typeof w[2]?p.apply(this,arguments).then(function(){"function"===typeof w[1]&&w[1].apply(null)},function(z){"function"===typeof w[2]&&w[2].apply(null,[z])}):p.apply(this,arguments)}});["getStats"].forEach(function(n){var p=u.prototype[n];u.prototype[n]=function(){var w=arguments;return"function"===typeof w[1]?p.apply(this,arguments).then(function(){"function"===typeof w[1]&&w[1].apply(null)}):p.apply(this,arguments)}});
...
e.matchPrefix(d,"a=rtcp-fb:"+l+" ").map(e.parseRtcpFb);g.codecs.push(f);switch(f.name.toUpperCase()){case "RED":case "ULPFEC":g.fecMechanisms.push(f.name.toUpperCase())}}}e.matchPrefix(d,"a=extmap:").forEach(function(v){g.headerExtensions.push(e.parseExtmap(v))});return g};e.writeRtpDescription=function(d,g){var h="";h+="m="+d+" ";h+=0<g.codecs.length?"9":"0";h+=" UDP/TLS/RTP/SAVPF ";h+=g.codecs.map(function(l){return void 0!==l.preferredPayloadType?l.preferredPayloadType:l.payloadType}).join(" ")+
...
this.touchListener=b.touchListener;this.onActionEnable=!0;this.onEvents=b.onEvents;this.onVideoLoaded=b.onVideoLoaded;this.orientationChangeTimeout=void 0;this.keyMap=new Map;document.addEventListener("WeixinJSBridgeReady",()=>{S.isInWeixinBrowser=!0;this.video.play()});this.create()}registerEvents(){window.addEventListener("orientationchange",()=>{clearTimeout(this.orientationChangeTimeout);this.orientationChangeTimeout=setTimeout(()=>this.player.resize(),500)});this.registerKeyboardEvents();this.registerMouseEvents();
...
a=>this.handleTouchMove(a),!1);this.video.addEventListener("touchend",a=>this.handleTouchEnd(a),!1);this.video.addEventListener("touchcancel",a=>this.handleTouchCancel(a),!1)}sendTouch(a,b){this.callOnUserInteraction();let c=new DataView(new ArrayBuffer(2+10*b.length));c.setUint8(0,a);c.setUint8(1,b.length);a=2;let e=[],d=this.video.getBoundingClientRect();for(let g of b){let h=g.clientX-d.left,q=g.clientY-d.top,l=this.normalizeAndQuantizeUnsigned(h,q),f=this.fingerIds[g.identifier];if(void 0==f){let m;
null==(m=this.onEvents)||m.call(this,`\tError! Invalid: ${g.identifier}, ${JSON.stringify(this.fingerIds)} ${JSON.stringify(this.fingers)}, count:${b.length}`)}else c.setUint16(a,l.x,!0),a+=2,c.setUint16(a,l.y,!0),a+=2,c.setInt32(a,f,!0),a+=4,c.setUint8(a,255*g.force,!0),a+=1,c.setUint8(a,l.inRange?1:0,!0),a+=1,e.push(`{${f} (${parseInt(h)},${parseInt(q)})->(${parseInt(l.x)},${parseInt(l.y)})}`)}this.player.doEventSync(c.buffer);this.rtc.send(c.buffer)}sendKeydown(a){this.callOnUserInteraction();
let b=Ba(a),c;null==(c=this.onEvents)||c.call(this,`Send KeyDown, Code:${b}, Repeat:${a.repeat}`);a=(new Uint8Array([60,b,a.repeat])).buffer;this.player.doEventSync(a);this.rtc.send(a)}sendKeyup(a){this.callOnUserInteraction();a=Ba(a);var b;null==(b=this.onEvents)||b.call(this,`Send KeyUp:${a}`);b=(new Uint8Array([61,a])).buffer;this.player.doEventSync(b);this.rtc.send(b)}sendKeypress(a){this.callOnUserInteraction();var b;null==(b=this.onEvents)||b.call(this,`Send KeyPress:${a.charCode}`);b=new DataView(new ArrayBuffer(3));
...
this.onEvents)||b.call(this,"Send MouseLeave")}sendMouseMove(a,b,c,e){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var d=this.normalizeAndQuantizeUnsigned(a,b),g=this.normalizeAndQuantizeSigned(c,e),h=new DataView(new ArrayBuffer(9));h.setUint8(0,74);h.setUint16(1,d.x,!0);h.setUint16(3,d.y,!0);h.setInt16(5,g.x,!0);h.setInt16(7,g.y,!0);this.player.doEventSync(h.buffer);this.rtc.send(h.buffer);var q;null==(q=this.onEvents)||q.call(this,`Send MouseMove, X:${a}, Y:${b}, DeltaX:${c}, DeltaY:${e}`)}}sendMouseDown(a,
b,c){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var e=this.normalizeAndQuantizeUnsigned(b,c),d=new DataView(new ArrayBuffer(6));d.setUint8(0,72);d.setUint8(1,a);d.setUint16(2,e.x,!0);d.setUint16(4,e.y,!0);this.player.doEventSync(d.buffer);this.rtc.send(d.buffer);var g;null==(g=this.onEvents)||g.call(this,`Send MouseDown, Button:${a}, X:${b}, Y:${c}`)}}sendMouseUp(a,b,c){if(this.normalizeAndQuantizeUnsigned){var e=this.normalizeAndQuantizeUnsigned(b,c),d=new DataView(new ArrayBuffer(6));
d.setUint8(0,73);d.setUint8(1,a);d.setUint16(2,e.x,!0);d.setUint16(4,e.y,!0);this.player.doEventSync(d.buffer);this.rtc.send(d.buffer);var g;null==(g=this.onEvents)||g.call(this,`Send MouseUp, Button:${a}, X:${b}, Y:${c}`)}}sendMouseWheel(a,b,c){this.callOnUserInteraction();if(this.normalizeAndQuantizeUnsigned){var e=this.normalizeAndQuantizeUnsigned(b,c),d=new DataView(new ArrayBuffer(7));d.setUint8(0,75);d.setInt16(1,a,!0);d.setUint16(3,e.x,!0);d.setUint16(5,e.y,!0);this.player.doEventSync(d.buffer);
this.rtc.send(d.buffer);var g;null==(g=this.onEvents)||g.call(this,`Send MouseWheel, Delta:${a}, X:${b}, Y:${c}`)}}}class xc extends ia{constructor(a,b,c){super(a);this.updateConnectionCount(b);this.createButton(c)}createButton(a){if(!this.elButton){this.elButton=document.createElement("button");this.elButton.id=`liveStatusSwitchButton_${this.uniqueId}`;this.elButton.innerHTML=da.Information;this.elButton.title=a;this.elButton.className="__liveStatusSwitchButton";if(S.isIOSDevice||S.isSafari)this.elButton.style.backgroundSize=
...
this.canAdaptiveResolution=1===a.count}}t.APIErrorCode=va;t.ActionMode={None:0,Follow:1,FollowBehindAndAbove:2,FollowBehind:3,FollowAbove:4,FollowBellow:5,FollowLeft:6,FollowRight:7,FollowWorldRotation:8};t.AnimatedImageButtonData=Xa;t.AssetType={EPT_Scene:1,EPT_ModelActor:2,EPT_Measurement:3,EPT_Cut:4,EPT_DynamicWater:5,EPT_Vehicle:6,EPT_Tag:7,EPT_Light:8,EPT_Decal:9,EPT_LightBeam:10,EPT_RadiationPoint:11,EPT_Surface:12,EPT_ShpPoint:13,EPT_ShpPolyline:14,EPT_ShpPolygon:15,EPT_Polyline:16,EPT_VideoProjector:17,
EPT_Panoramic:18,EPT_FlattenModifier:19,EPT_Cesium:20,EPT_CutPolygonModifier:21,EPT_EffectPoint:22,EPT_S3MLayer:23,EPT_ParticleActor:24,EPT_RoleActor:25,EPT_SoundActor:26,EPT_CustomActor:27,EPT_CameraTour:28,EPT_Animation:29};t.BPFuncParamType={Bool:0,UInt8:1,Int32:2,Float:3,Double:4,String:5,Color:6,Vector2D:7,Vector:8,Rotator:9,IntArray:10,StringArray:11,VectorArray:12,Coordinate:13,CoordinateArray:14,FloatArray:15,DisplayStyle:16,CustomIconPath:17};t.BPFunctionData=kb;t.BeamData=Ya;t.CameraTourData=
mb;t.CameraTourKeyFrame=lb;t.CloudStatus=U;t.Color={LightPink:"RGB(255,182,193)",Pink:"RGB(255,192,203)",Crimson:"RGB(220,20,60)",LavenderBlush:"RGB(255,240,245)",PaleVioletRed:"RGB(219,112,147)",HotPink:"RGB(255,105,180)",DeepPink:"RGB(255,20,147)",MediumVioletRed:"RGB(199,21,133)",Orchid:"RGB(218,112,214)",Thistle:"RGB(216,191,216)",plum:"RGB(221,160,221)",Violet:"RGB(238,130,238)",Magenta:"RGB(255,0,255)",Fuchsia:"RGB(255,0,255)",DarkMagenta:"RGB(139,0,139)",Purple:"RGB(128,0,128)",MediumOrchid:"RGB(186,85,211)",
...
WhiteSmoke:"RGB(245,245,245)",Gainsboro:"RGB(220,220,220)",LightGrey:"RGB(211,211,211)",Silver:"RGB(192,192,192)",DarkGray:"RGB(169,169,169)",Gray:"RGB(128,128,128)",DimGray:"RGB(105,105,105)",Black:"RGB(0,0,0)"};t.CommandType=k;t.CustomObjectData=gb;t.CustomObjectData2=hb;t.CustomTagData=Ua;t.DecalData=eb;t.DigitalTwinAPI=ta;t.DigitalTwinPlayer=Dc;t.DynamicWaterData=jb;t.FieldType={String:0,Number:1};t.HeatMapPointData=Ra;t.HeatMapStyle={Normal:-1,CustomColor:0,CustomWave:1};t.HighlightAreaData=
Va;t.HydroDynamic2DStyle={TrueWater:0,HeatMap:1};t.ImageButtonData=Wa;t.LayerVisibleData=Qa;t.MapMode={Campass:0,SmallMap:1,BigMap:2};t.MeasurementMode={Coordinate:1,Linear:2,Horizontal:3,Vertical:4,MultiPoint:5,TerrainArea:6};t.MousePickMask=ra;t.ODLineData=bb;t.PanelType={ViewshedAnalysis:0,SkylineAnalysis:1,ViewDomeAnalysis:2,VisiblityAnalysis:3,FloodFillAnalysis:4,SolarAnalysis:5,CutFillAnalysis:6,TerrainSlopeAnalysi:7,ContourLineAnalysis:8};t.PanoramaData=db;t.Polygon3DData=$a;t.Polygon3DStyle=
{Wave:0,LoopLine:1,Gradual:2,DynamicGradual:3,WaveTransparent:4,WideWave:5,RotateArrow:6,RotateLine:7,RotateGradual:8,SingleColor:9,SingleColorWithLight:10,OriginColor:11,OceanWater:12,LakeWater:13,Opacity:14,Mask:15,Transparent:16,Volumn:17};t.PolygonData=cb;t.PolygonStyle={SingleColor:0,CirclePoint:1,Volumn:2,Gradual:3,DynamicGradual:4,WaveTransparent:5,WideWave:6,RotateArrow:7,RotateLine:8,RotateGradual:9,OnTerrain:10,OriginColor:11};t.PolylineData=ab;t.PolylineStyle={Arrow:0,Arrow1:1,Flow:2,Beam:3,
Normal:4,OnTerrain:5,DottedNormal:6,DottedCircle:7,OriginColor:8};t.REVISION=19681;t.RadiationPointData=Za;t.RendererType={SimpleRenderer:0,UniqueValueRenderer:1,ClassBreaksRenderer:2,VisibleRenderer:3};t.ResetType=Da;t.SplineMeshStyle={Fence_1:0,Fence_2:1,Wall_1:2,Wall_2:3,Road_0:4,Road_1:5,Road_2:6,Road_3:7,Road_4:8,Road_5:9,Road_6:10,Road_7:11,Road_8:12,Road_9:13,Fence_Tree:14,Pipe:15};t.TagData=Sa;t.TileLayerActorData=fa;t.TileLayerData=fb;t.UIPanelType={MainUI:0,NewACP:1,OpenACP:2,MergeACP:3,
...
Settings:46,Help:47,ViewshedAnalysis:48,SkylineAnalysis:49,ViewDomeAnalysis:50,VisiblityAnalysis:51,FloodFillAnalysis:52,SolarAnalysis:53,CutFillAnalysis:54,TerrainSlopeAnalysi:55,ContourLineAnalysis:56};t.VERSION="6.1";t.VectorFieldStyle={Typhoon:"DTS_TPHOON",Waves:"DTS_WAVE",Ocean:"DTS_OCEAN",Fluid:"DTS_STYLE_FLUID",Fluid_UV:"DTS_FLUID_COUNT_XYZ_UV",River:"DTS_RIVER",Wave:"DTS_WATER_WAVE"};t.VehicleViewMode={FirstPerson:0,ThirdPerson:1};t.VideoProjectionData=ib;t.Viewport=ca;t.VisualType={Color:0,
Size:1,Height:1,Opacity:1};t.WaterFlowFieldStyle={HeatMap:0,Water:1,Particle:2};t.WaterMode={Animation:0,Simulation:1,Arrow:2};t.WebUIData=Ta;t.__onCefResponse=function(a,b){if(xa)xa.onConnectionMessage(a,b)};Object.defineProperty(t,"__esModule",{value:!0});return t}({});
(()=>{if("undefined"!=typeof module&&module.exports)module.exports=acapi;else if("function"==typeof define&&define.amd)define(function(){return acapi});else{window.AcApiVersion=acapi.VERSION;acapi.AirCityAPI=acapi.DigitalTwinAPI;acapi.AirCityPlayer=acapi.DigitalTwinPlayer;for(let t in acapi)"VERSION"!=t&&(window[t]=acapi[t]);acapi.DigitalTwinAPI.__onApiConstructed=t=>{window.__g=t;window.fdapi=t}}})();
